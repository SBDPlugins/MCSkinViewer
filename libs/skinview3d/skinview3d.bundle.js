const NodeCanvas = require("node-canvas-webgl"), document = {
    createElement: function (a) {
        return "canvas" === a ? NodeCanvas.createCanvas() : "img" === a ? new NodeCanvas.Image : void 0
    }
};
eval("var window = {}"), eval("var HTMLImageElement = null"), eval("var HTMLVideoElement = null"), eval("var HTMLCanvasElement = null"), eval("var ImageBitmap = null"), eval("var OffscreenCanvas = null"), HTMLImageElement = NodeCanvas.Image, HTMLVideoElement = ImageBitmap = OffscreenCanvas = function () {
}, HTMLCanvasElement = function () {
}, window.devicePixelRatio = 1, window.requestAnimationFrame = function (a) {
    a()
}
...
!function (e, t) {
    ...
    "use strict";
    const t = 0, i = 1, n = 2, r = 0, a = 1, s = 2, o = 3, l = 100, c = 301, h = 302, u = 303, d = 306, p = 1e3,
        f = 1001, m = 1002, g = 1003, v = 1006, _ = 1008, x = 1009, y = 1014, M = 1015, b = 1016, S = 1020, w = 1023,
        T = 1026, E = 1027, A = 33776, C = 33777, L = 33778, P = 33779, R = 3e3, D = 3001, I = "srgb",
        N = "srgb-linear", z = 7680, O = "300 es", F = 1035;
    ...
    class Y {
        constructor() {
            Y.prototype.isMatrix3 = !0, this.elements = [1, 0, 0, 0, 1, 0, 0, 0, 1], arguments.length > 0 && console.error("THREE.Matrix3: the constructor no longer reads arguments. use .set() instead.")
        }
        ...
        multiplyMatrices(e, t) {
            const i = e.elements, n = t.elements, r = this.elements, a = i[0], s = i[3], o = i[6], l = i[1], c = i[4],
                h = i[7], u = i[2], d = i[5], p = i[8], f = n[0], m = n[3], g = n[6], v = n[1], _ = n[4], x = n[7],
                y = n[2], M = n[5], b = n[8];
        ...
        invert() {
            const e = this.elements, t = e[0], i = e[1], n = e[2], r = e[3], a = e[4], s = e[5], o = e[6], l = e[7],
                c = e[8], h = c * a - s * l, u = s * o - c * r, d = l * r - a * o, p = t * h + i * u + n * d;
        ...
        rotate(e) {
            const t = Math.cos(e), i = Math.sin(e), n = this.elements, r = n[0], a = n[3], s = n[6], o = n[1], l = n[4],
                c = n[7];
    ...
    }, ie = {r: 0, g: 0, b: 0}, ne = {h: 0, s: 0, l: 0}, re = {h: 0, s: 0, l: 0};
    ...
    class oe {
        ...
        setHex(e, t = "srgb") {
            return e = Math.floor(e), this.r = (e >> 16 & 255) / 255, this.g = (e >> 8 & 255) / 255, this.b = (255 & e) / 255, ee.toWorkingColorSpace(this, t), this
        }

        setRGB(e, t, i, n = "srgb-linear") {
            return this.r = e, this.g = t, this.b = i, ee.toWorkingColorSpace(this, n), this
        }

        setHSL(e, t, i, n = "srgb-linear") {
            var r;
            if (e = (e % (r = 1) + r) % r, t = V(t, 0, 1), i = V(i, 0, 1), 0 === t) this.r = this.g = this.b = i; else {
                const n = i <= .5 ? i * (1 + t) : i + t - i * t, r = 2 * i - n;
                this.r = ae(r, n, e + 1 / 3), this.g = ae(r, n, e), this.b = ae(r, n, e - 1 / 3)
            }
            return ee.toWorkingColorSpace(this, n), this
        }
        ...
        setStyle(e, t = "srgb") {
            ...
            if (n = /^((?:rgb|hsl)a?)\(([^\)]*)\)/.exec(e)) {
                ...
                switch (r) {
                    case"rgb":
                    case"rgba":
                        if (e = /^\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*(\d*\.?\d+)\s*)?$/.exec(a)) return this.r = Math.min(255, parseInt(e[1], 10)) / 255, this.g = Math.min(255, parseInt(e[2], 10)) / 255, this.b = Math.min(255, parseInt(e[3], 10)) / 255, ee.toWorkingColorSpace(this, t), i(e[4]), this;
                        if (e = /^\s*(\d+)\%\s*,\s*(\d+)\%\s*,\s*(\d+)\%\s*(?:,\s*(\d*\.?\d+)\s*)?$/.exec(a)) return this.r = Math.min(100, parseInt(e[1], 10)) / 100, this.g = Math.min(100, parseInt(e[2], 10)) / 100, this.b = Math.min(100, parseInt(e[3], 10)) / 100, ee.toWorkingColorSpace(this, t), i(e[4]), this;
                        break;
                    case"hsl":
                    case"hsla":
                        if (e = /^\s*(\d*\.?\d+)\s*,\s*(\d+)\%\s*,\s*(\d+)\%\s*(?:,\s*(\d*\.?\d+)\s*)?$/.exec(a)) {
                            const n = parseFloat(e[1]) / 360, r = parseInt(e[2], 10) / 100,
                                a = parseInt(e[3], 10) / 100;
                            return i(e[4]), this.setHSL(n, r, a, t)
                        }
                }
            } else if (n = /^\#([A-Fa-f\d]+)$/.exec(e)) {
                const e = n[1], i = e.length;
                if (3 === i) return this.r = parseInt(e.charAt(0) + e.charAt(0), 16) / 255, this.g = parseInt(e.charAt(1) + e.charAt(1), 16) / 255, this.b = parseInt(e.charAt(2) + e.charAt(2), 16) / 255, ee.toWorkingColorSpace(this, t), this;
                if (6 === i) return this.r = parseInt(e.charAt(0) + e.charAt(1), 16) / 255, this.g = parseInt(e.charAt(2) + e.charAt(3), 16) / 255, this.b = parseInt(e.charAt(4) + e.charAt(5), 16) / 255, ee.toWorkingColorSpace(this, t), this
            }
        ...
        getHex(e = "srgb") {
            return ee.fromWorkingColorSpace(se(this, ie), e), V(255 * ie.r, 0, 255) << 16 ^ V(255 * ie.g, 0, 255) << 8 ^ V(255 * ie.b, 0, 255) << 0
        }
        ...
        getHSL(e, t = "srgb-linear") {
            ee.fromWorkingColorSpace(se(this, ie), t);
            const i = ie.r, n = ie.g, r = ie.b, a = Math.max(i, n, r), s = Math.min(i, n, r);
            let o, l;
            const c = (s + a) / 2;
            if (s === a) o = 0, l = 0; else {
                const e = a - s;
        ...
        getRGB(e, t = "srgb-linear") {
            return ee.fromWorkingColorSpace(se(this, ie), t), e.r = ie.r, e.g = ie.g, e.b = ie.b, e
        }

        getStyle(e = "srgb") {
            return ee.fromWorkingColorSpace(se(this, ie), e), e !== I ? `color(${e} ${ie.r} ${ie.g} ${ie.b})` : `rgb(${255 * ie.r | 0},${255 * ie.g | 0},${255 * ie.b | 0})`
        }

        offsetHSL(e, t, i) {
            return this.getHSL(ne), ne.h += e, ne.s += t, ne.l += i, this.setHSL(ne.h, ne.s, ne.l), this
        }
        ...
        lerpHSL(e, t) {
            this.getHSL(ne), e.getHSL(re);
            const i = W(ne.h, re.h, t), n = W(ne.s, re.s, t), r = W(ne.l, re.l, t);
    ...
    class ce {
        static getDataURL(e) {
            ...
            if (e instanceof HTMLCanvasElement) t = e; else {
                void 0 === le && (le = K("canvas")), le.width = e.width, le.height = e.height;
                const i = le.getContext("2d");
                e instanceof ImageData ? i.putImageData(e, 0, 0) : i.drawImage(e, 0, 0, e.width, e.height), t = le
            }
        ...
        static sRGBToLinear(e) {
            ...
            if (e.data) {
                ...
                for (let e = 0; e < t.length; e++) t instanceof Uint8Array || t instanceof Uint8ClampedArray ? t[e] = Math.floor(255 * J(t[e] / 255)) : t[e] = J(t[e]);
    ...
    class he {
        ...
        toJSON(e) {
            ...
            if (null !== n) {
                ...
                if (Array.isArray(n)) {
                    e = [];
                    for (let t = 0, i = n.length; t < i; t++) n[t].isDataTexture ? e.push(ue(n[t].image)) : e.push(ue(n[t]))
                } else e = ue(n);
                i.url = e
            }
    ...
    function ue(e) {
        return "undefined" != typeof HTMLImageElement && e instanceof HTMLImageElement || "undefined" != typeof HTMLCanvasElement && e instanceof HTMLCanvasElement || "undefined" != typeof ImageBitmap && e instanceof ImageBitmap ? ce.getDataURL(e) : e.data ? {
    ...
    class pe extends U {
        constructor(e = pe.DEFAULT_IMAGE, t = pe.DEFAULT_MAPPING, i = 1001, n = 1001, r = 1006, a = 1008, s = 1023, o = 1009, l = 1, c = 3e3) {
            super(), this.isTexture = !0, Object.defineProperty(this, "id", {value: de++}), this.uuid = G(), this.name = "", this.source = new he(e), this.mipmaps = [], this.mapping = t, this.wrapS = i, this.wrapT = n, this.magFilter = r, this.minFilter = a, this.anisotropy = l, this.format = s, this.internalFormat = null, this.type = o, this.offset = new X(0, 0), this.repeat = new X(1, 1), this.center = new X(0, 0), this.rotation = 0, this.matrixAutoUpdate = !0, this.matrix = new Y, this.generateMipmaps = !0, this.premultiplyAlpha = !1, this.flipY = !0, this.unpackAlignment = 4, this.encoding = c, this.userData = {}, this.version = 0, this.onUpdate = null, this.isRenderTargetTexture = !1, this.needsPMREMUpdate = !1
        }
    ...
    class fe {
        ...
        setAxisAngleFromRotationMatrix(e) {
            let t, i, n, r;
            const a = .01, s = .1, o = e.elements, l = o[0], c = o[4], h = o[8], u = o[1], d = o[5], p = o[9], f = o[2],
                m = o[6], g = o[10];
            if (Math.abs(c - u) < a && Math.abs(h - f) < a && Math.abs(p - m) < a) {
                ...
                t = Math.PI;
                const e = (l + 1) / 2, o = (d + 1) / 2, v = (g + 1) / 2, _ = (c + u) / 4, x = (h + f) / 4,
                    y = (p + m) / 4;
    ...
    class me extends U {
        constructor(e, t, i = {}) {
            super(), this.isWebGLRenderTarget = !0, this.width = e, this.height = t, this.depth = 1, this.scissor = new fe(0, 0, e, t), this.scissorTest = !1, this.viewport = new fe(0, 0, e, t);
            const n = {width: e, height: t, depth: 1};
            this.texture = new pe(n, i.mapping, i.wrapS, i.wrapT, i.magFilter, i.minFilter, i.format, i.type, i.anisotropy, i.encoding), this.texture.isRenderTargetTexture = !0, this.texture.flipY = !1, this.texture.generateMipmaps = void 0 !== i.generateMipmaps && i.generateMipmaps, this.texture.internalFormat = void 0 !== i.internalFormat ? i.internalFormat : null, this.texture.minFilter = void 0 !== i.minFilter ? i.minFilter : v, this.depthBuffer = void 0 === i.depthBuffer || i.depthBuffer, this.stencilBuffer = void 0 !== i.stencilBuffer && i.stencilBuffer, this.depthTexture = void 0 !== i.depthTexture ? i.depthTexture : null, this.samples = void 0 !== i.samples ? i.samples : 0
        }
        ...
        copy(e) {
            ...
            return this.texture.source = new he(t), this.depthBuffer = e.depthBuffer, this.stencilBuffer = e.stencilBuffer, null !== e.depthTexture && (this.depthTexture = e.depthTexture.clone()), this.samples = e.samples, this
        }
    ...
    class _e {
        ...
        static multiplyQuaternionsFlat(e, t, i, n, r, a) {
            const s = i[n], o = i[n + 1], l = i[n + 2], c = i[n + 3], h = r[a], u = r[a + 1], d = r[a + 2],
                p = r[a + 3];
        ...
        setFromEuler(e, t) {
            ...
            const i = e._x, n = e._y, r = e._z, a = e._order, s = Math.cos, o = Math.sin, l = s(i / 2), c = s(n / 2),
                h = s(r / 2), u = o(i / 2), d = o(n / 2), p = o(r / 2);
            switch (a) {
                case"XYZ":
        ...
        slerp(e, t) {
            ...
            const l = Math.sqrt(o), c = Math.atan2(l, s), h = Math.sin((1 - t) * c) / l, u = Math.sin(t * c) / l;
    ...
    class xe {
        constructor(e = 0, t = 0, i = 0) {
            xe.prototype.isVector3 = !0, this.x = e, this.y = t, this.z = i
        }
        ...
        applyEuler(e) {
            return e && e.isEuler || console.error("THREE.Vector3: .applyEuler() now expects an Euler rotation rather than a Vector3 and order."), this.applyQuaternion(Me.setFromEuler(e))
        }
        ...
        applyQuaternion(e) {
            const t = this.x, i = this.y, n = this.z, r = e.x, a = e.y, s = e.z, o = e.w, l = o * t + a * n - s * i,
                c = o * i + s * t - r * n, h = o * n + r * i - a * t, u = -r * t - a * i - s * n;
    ...
    const ye = new xe, Me = new _e;

    class be {
        constructor(e = new xe(1 / 0, 1 / 0, 1 / 0), t = new xe(-1 / 0, -1 / 0, -1 / 0)) {
        ...
        setFromCenterAndSize(e, t) {
            const i = we.copy(t).multiplyScalar(.5);
        ...
        expandByObject(e, t = !1) {
            ...
            if (void 0 !== i) if (t && null != i.attributes && void 0 !== i.attributes.position) {
                ...
                for (let i = 0, n = t.count; i < n; i++) we.fromBufferAttribute(t, i).applyMatrix4(e.matrixWorld), this.expandByPoint(we)
            } else null === i.boundingBox && i.computeBoundingBox(), Te.copy(i.boundingBox), Te.applyMatrix4(e.matrixWorld), this.union(Te);
            const n = e.children;
        ...
        intersectsTriangle(e) {
            ...
            this.getCenter(De), Ie.subVectors(this.max, De), Ee.subVectors(e.a, De), Ae.subVectors(e.b, De), Ce.subVectors(e.c, De), Le.subVectors(Ae, Ee), Pe.subVectors(Ce, Ae), Re.subVectors(Ee, Ce);
            let t = [0, -Le.z, Le.y, 0, -Pe.z, Pe.y, 0, -Re.z, Re.y, Le.z, 0, -Le.x, Pe.z, 0, -Pe.x, Re.z, 0, -Re.x, -Le.y, Le.x, 0, -Pe.y, Pe.x, 0, -Re.y, Re.x, 0];
            return !!Oe(t, Ee, Ae, Ce, Ie) && (t = [1, 0, 0, 0, 1, 0, 0, 0, 1], !!Oe(t, Ee, Ae, Ce, Ie) && (Ne.crossVectors(Le, Pe), t = [Ne.x, Ne.y, Ne.z], Oe(t, Ee, Ae, Ce, Ie)))
        }
        ...
        distanceToPoint(e) {
            return we.copy(e).clamp(this.min, this.max).sub(e).length()
        }

        getBoundingSphere(e) {
            return this.getCenter(e.center), e.radius = .5 * this.getSize(we).length(), e
        }
        ...
        applyMatrix4(e) {
            return this.isEmpty() || (Se[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e), Se[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(e), Se[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(e), Se[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(e), Se[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(e), Se[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(e), Se[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(e), Se[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(e), this.setFromPoints(Se)), this
        }
    ...
    const Se = [new xe, new xe, new xe, new xe, new xe, new xe, new xe, new xe], we = new xe, Te = new be, Ee = new xe,
        Ae = new xe, Ce = new xe, Le = new xe, Pe = new xe, Re = new xe, De = new xe, Ie = new xe, Ne = new xe,
        ze = new xe;

    function Oe(e, t, i, n, r) {
        for (let a = 0, s = e.length - 3; a <= s; a += 3) {
            ze.fromArray(e, a);
            const s = r.x * Math.abs(ze.x) + r.y * Math.abs(ze.y) + r.z * Math.abs(ze.z), o = t.dot(ze), l = i.dot(ze),
                c = n.dot(ze);
    ...
    const Fe = new be, Ue = new xe, ke = new xe, Be = new xe;
    ...
    class He {
        ...
        expandByPoint(e) {
            ...
            if (t > this.radius * this.radius) {
                ...
                this.center.add(Be.multiplyScalar(i / e)), this.radius += i
            }
            return this
        }

        union(e) {
            return !0 === this.center.equals(e.center) ? ke.set(0, 0, 1).multiplyScalar(e.radius) : ke.subVectors(e.center, this.center).normalize().multiplyScalar(e.radius), this.expandByPoint(Ue.copy(e.center).add(ke)), this.expandByPoint(Ue.copy(e.center).sub(ke)), this
        }
    ...
    const Ge = new xe, Ve = new xe, We = new xe, je = new xe, qe = new xe, Xe = new xe, Ye = new xe;
    ...
    class Ze {
        ...
        distanceSqToPoint(e) {
            ...
            return t < 0 ? this.origin.distanceToSquared(e) : (Ge.copy(this.direction).multiplyScalar(t).add(this.origin), Ge.distanceToSquared(e))
        }

        distanceSqToSegment(e, t, i, n) {
            Ve.copy(e).add(t).multiplyScalar(.5), We.copy(t).sub(e).normalize(), je.copy(this.origin).sub(Ve);
            const r = .5 * e.distanceTo(t), a = -this.direction.dot(We), s = je.dot(this.direction), o = -je.dot(We),
                l = je.lengthSq(), c = Math.abs(1 - a * a);
            let h, u, d, p;
            if (c > 0) if (h = a * o - s, u = a * s - o, p = r * c, h >= 0) if (u >= -p) if (u <= p) {
                const e = 1 / c;
                h *= e, u *= e, d = h * (h + a * u + 2 * s) + u * (a * h + u + 2 * o) + l
            } else u = r, h = Math.max(0, -(a * u + s)), d = -h * h + u * (u + 2 * o) + l; else u = -r, h = Math.max(0, -(a * u + s)), d = -h * h + u * (u + 2 * o) + l; else u <= -p ? (h = Math.max(0, -(-a * r + s)), u = h > 0 ? -r : Math.min(Math.max(-r, -o), r), d = -h * h + u * (u + 2 * o) + l) : u <= p ? (h = 0, u = Math.min(Math.max(-r, -o), r), d = u * (u + 2 * o) + l) : (h = Math.max(0, -(a * r + s)), u = h > 0 ? r : Math.min(Math.max(-r, -o), r), d = -h * h + u * (u + 2 * o) + l); else u = a > 0 ? -r : r, h = Math.max(0, -(a * u + s)), d = -h * h + u * (u + 2 * o) + l;
            return i && i.copy(this.direction).multiplyScalar(h).add(this.origin), n && n.copy(We).multiplyScalar(u).add(Ve), d
        }

        intersectSphere(e, t) {
            Ge.subVectors(e.center, this.origin);
            const i = Ge.dot(this.direction), n = Ge.dot(Ge) - i * i, r = e.radius * e.radius;
            if (n > r) return null;
        ...
        intersectTriangle(e, t, i, n, r) {
            qe.subVectors(t, e), Xe.subVectors(i, e), Ye.crossVectors(qe, Xe);
            let a, s = this.direction.dot(Ye);
            if (s > 0) {
                if (n) return null;
                a = 1
            } else {
            ...
            const o = a * this.direction.dot(Xe.crossVectors(je, Xe));
            if (o < 0) return null;
            const l = a * this.direction.dot(qe.cross(je));
            if (l < 0) return null;
    ...
    class Ke {
        ...
        extractRotation(e) {
            const t = this.elements, i = e.elements, n = 1 / Je.setFromMatrixColumn(e, 0).length(),
                r = 1 / Je.setFromMatrixColumn(e, 1).length(), a = 1 / Je.setFromMatrixColumn(e, 2).length();
        ...
        makeRotationFromQuaternion(e) {
            return this.compose($e, e, et)
        }

        lookAt(e, t, i) {
            const n = this.elements;
            return nt.subVectors(e, t), 0 === nt.lengthSq() && (nt.z = 1), nt.normalize(), tt.crossVectors(i, nt), 0 === tt.lengthSq() && (1 === Math.abs(i.z) ? nt.x += 1e-4 : nt.z += 1e-4, nt.normalize(), tt.crossVectors(i, nt)), tt.normalize(), it.crossVectors(nt, tt), n[0] = tt.x, n[4] = it.x, n[8] = nt.x, n[1] = tt.y, n[5] = it.y, n[9] = nt.y, n[2] = tt.z, n[6] = it.z, n[10] = nt.z, this
        }
        ...
        multiplyMatrices(e, t) {
            const i = e.elements, n = t.elements, r = this.elements, a = i[0], s = i[4], o = i[8], l = i[12], c = i[1],
                h = i[5], u = i[9], d = i[13], p = i[2], f = i[6], m = i[10], g = i[14], v = i[3], _ = i[7], x = i[11],
                y = i[15], M = n[0], b = n[4], S = n[8], w = n[12], T = n[1], E = n[5], A = n[9], C = n[13], L = n[2],
                P = n[6], R = n[10], D = n[14], I = n[3], N = n[7], z = n[11], O = n[15];
        ...
        compose(e, t, i) {
            const n = this.elements, r = t._x, a = t._y, s = t._z, o = t._w, l = r + r, c = a + a, h = s + s, u = r * l,
                d = r * c, p = r * h, f = a * c, m = a * h, g = s * h, v = o * l, _ = o * c, x = o * h, y = i.x,
                M = i.y, b = i.z;
        ...
        decompose(e, t, i) {
            const n = this.elements;
            let r = Je.set(n[0], n[1], n[2]).length();
            const a = Je.set(n[4], n[5], n[6]).length(), s = Je.set(n[8], n[9], n[10]).length();
            this.determinant() < 0 && (r = -r), e.x = n[12], e.y = n[13], e.z = n[14], Qe.copy(this);
            const o = 1 / r, l = 1 / a, c = 1 / s;
            return Qe.elements[0] *= o, Qe.elements[1] *= o, Qe.elements[2] *= o, Qe.elements[4] *= l, Qe.elements[5] *= l, Qe.elements[6] *= l, Qe.elements[8] *= c, Qe.elements[9] *= c, Qe.elements[10] *= c, t.setFromRotationMatrix(Qe), i.x = r, i.y = a, i.z = s, this
        }

        makePerspective(e, t, i, n, r, a) {
            void 0 === a && console.warn("THREE.Matrix4: .makePerspective() has been redefined and has a new signature. Please check the docs.");
            const s = this.elements, o = 2 * r / (t - e), l = 2 * r / (i - n), c = (t + e) / (t - e),
                h = (i + n) / (i - n), u = -(a + r) / (a - r), d = -2 * a * r / (a - r);
    ...
    const Je = new xe, Qe = new Ke, $e = new xe(0, 0, 0), et = new xe(1, 1, 1), tt = new xe, it = new xe, nt = new xe,
        rt = new Ke, at = new _e;

    class st {
        constructor(e = 0, t = 0, i = 0, n = st.DefaultOrder) {
        ...
        setFromRotationMatrix(e, t = this._order, i = !0) {
            const n = e.elements, r = n[0], a = n[4], s = n[8], o = n[1], l = n[5], c = n[9], h = n[2], u = n[6],
                d = n[10];
            switch (t) {
                case"XYZ":
                    this._y = Math.asin(V(s, -1, 1)), Math.abs(s) < .9999999 ? (this._x = Math.atan2(-c, d), this._z = Math.atan2(-a, r)) : (this._x = Math.atan2(u, l), this._z = 0);
                    break;
                case"YXZ":
                    this._x = Math.asin(-V(c, -1, 1)), Math.abs(c) < .9999999 ? (this._y = Math.atan2(s, d), this._z = Math.atan2(o, l)) : (this._y = Math.atan2(-h, r), this._z = 0);
                    break;
                case"ZXY":
                    this._x = Math.asin(V(u, -1, 1)), Math.abs(u) < .9999999 ? (this._y = Math.atan2(-h, d), this._z = Math.atan2(-a, l)) : (this._y = 0, this._z = Math.atan2(o, r));
                    break;
                case"ZYX":
                    this._y = Math.asin(-V(h, -1, 1)), Math.abs(h) < .9999999 ? (this._x = Math.atan2(u, d), this._z = Math.atan2(o, r)) : (this._x = 0, this._z = Math.atan2(-a, l));
                    break;
                case"YZX":
                    this._z = Math.asin(V(o, -1, 1)), Math.abs(o) < .9999999 ? (this._x = Math.atan2(-c, l), this._y = Math.atan2(-h, r)) : (this._x = 0, this._y = Math.atan2(s, d));
                    break;
                case"XZY":
                    this._z = Math.asin(-V(a, -1, 1)), Math.abs(a) < .9999999 ? (this._x = Math.atan2(u, l), this._y = Math.atan2(s, r)) : (this._x = Math.atan2(-c, d), this._y = 0);
                    break;
                default:
        ...
        setFromQuaternion(e, t, i) {
            return rt.makeRotationFromQuaternion(e), this.setFromRotationMatrix(rt, t, i)
        }
        ...
        reorder(e) {
            return at.setFromEuler(this), this.setFromQuaternion(at, e)
        }
    ...
    st.DefaultOrder = "XYZ", st.RotationOrders = ["XYZ", "YZX", "ZXY", "XZY", "YXZ", "ZYX"];
    ...
    let lt = 0;
    const ct = new xe, ht = new _e, ut = new Ke, dt = new xe, pt = new xe, ft = new xe, mt = new _e,
        gt = new xe(1, 0, 0), vt = new xe(0, 1, 0), _t = new xe(0, 0, 1), xt = {type: "added"}, yt = {type: "removed"};

    class Mt extends U {
        constructor() {
            super(), this.isObject3D = !0, Object.defineProperty(this, "id", {value: lt++}), this.uuid = G(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = Mt.DefaultUp.clone();
            const e = new xe, t = new st, i = new _e, n = new xe(1, 1, 1);
            ...
            }), this.matrix = new Ke, this.matrixWorld = new Ke, this.matrixAutoUpdate = Mt.DefaultMatrixAutoUpdate, this.matrixWorldNeedsUpdate = !1, this.layers = new ot, this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.animations = [], this.userData = {}
        }
        ...
        translateOnAxis(e, t) {
            return ct.copy(e).applyQuaternion(this.quaternion), this.position.add(ct.multiplyScalar(t)), this
        }
        ...
        lookAt(e, t, i) {
            e.isVector3 ? dt.copy(e) : dt.set(e, t, i);
            const n = this.parent;
            this.updateWorldMatrix(!0, !1), pt.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? ut.lookAt(pt, dt, this.up) : ut.lookAt(dt, pt, this.up), this.quaternion.setFromRotationMatrix(ut), n && (ut.extractRotation(n.matrixWorld), ht.setFromRotationMatrix(ut), this.quaternion.premultiply(ht.invert()))
        }
        ...
        add(e) {
            ...
            return e === this ? (console.error("THREE.Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (null !== e.parent && e.parent.remove(e), e.parent = this, this.children.push(e), e.dispatchEvent(xt)) : console.error("THREE.Object3D.add: object not an instance of THREE.Object3D.", e), this)
        }
        ...
        remove(e) {
            ...
            return -1 !== t && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(yt)), this
        }
        ...
        attach(e) {
            return this.updateWorldMatrix(!0, !1), ut.copy(this.matrixWorld).invert(), null !== e.parent && (e.parent.updateWorldMatrix(!0, !1), ut.multiply(e.parent.matrixWorld)), e.applyMatrix4(ut), this.add(e), e.updateWorldMatrix(!1, !0), this
        }
        ...
        getWorldQuaternion(e) {
            return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(pt, e, ft), e
        }

        getWorldScale(e) {
            return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(pt, mt, e), e
        }
        ...
        toJSON(e) {
            ...
            if (t) {
                const t = a(e.geometries), n = a(e.materials), r = a(e.textures), s = a(e.images), o = a(e.shapes),
                    l = a(e.skeletons), c = a(e.animations), h = a(e.nodes);
    ...
    Mt.DefaultUp = new xe(0, 1, 0), Mt.DefaultMatrixAutoUpdate = !0;
    const bt = new xe, St = new xe, wt = new xe, Tt = new xe, Et = new xe, At = new xe, Ct = new xe, Lt = new xe,
        Pt = new xe, Rt = new xe;
    ...
    class Dt {
        ...
        static getNormal(e, t, i, n) {
            n.subVectors(i, t), bt.subVectors(e, t), n.cross(bt);
            const r = n.lengthSq();
            return r > 0 ? n.multiplyScalar(1 / Math.sqrt(r)) : n.set(0, 0, 0)
        }

        static getBarycoord(e, t, i, n, r) {
            bt.subVectors(n, t), St.subVectors(i, t), wt.subVectors(e, t);
            const a = bt.dot(bt), s = bt.dot(St), o = bt.dot(wt), l = St.dot(St), c = St.dot(wt), h = a * l - s * s;
        ...
        static containsPoint(e, t, i, n) {
            return this.getBarycoord(e, t, i, n, Tt), Tt.x >= 0 && Tt.y >= 0 && Tt.x + Tt.y <= 1
        }

        static getUV(e, t, i, n, r, a, s, o) {
            return this.getBarycoord(e, t, i, n, Tt), o.set(0, 0), o.addScaledVector(r, Tt.x), o.addScaledVector(a, Tt.y), o.addScaledVector(s, Tt.z), o
        }

        static isFrontFacing(e, t, i, n) {
            return bt.subVectors(i, t), St.subVectors(e, t), bt.cross(St).dot(n) < 0
        }
        ...
        getArea() {
            return bt.subVectors(this.c, this.b), St.subVectors(this.a, this.b), .5 * bt.cross(St).length()
        }
        ...
        getUV(e, t, i, n, r) {
            return Dt.getUV(e, this.a, this.b, this.c, t, i, n, r)
        }
        ...
        closestPointToPoint(e, t) {
            ...
            let a, s;
            Et.subVectors(n, i), At.subVectors(r, i), Lt.subVectors(e, i);
            const o = Et.dot(Lt), l = At.dot(Lt);
            if (o <= 0 && l <= 0) return t.copy(i);
            Pt.subVectors(e, n);
            const c = Et.dot(Pt), h = At.dot(Pt);
            if (c >= 0 && h <= c) return t.copy(n);
            const u = o * h - c * l;
            if (u <= 0 && o >= 0 && c <= 0) return a = o / (o - c), t.copy(i).addScaledVector(Et, a);
            Rt.subVectors(e, r);
            const d = Et.dot(Rt), p = At.dot(Rt);
            if (p >= 0 && d <= p) return t.copy(r);
            const f = d * l - o * p;
            if (f <= 0 && l >= 0 && p <= 0) return s = l / (l - p), t.copy(i).addScaledVector(At, s);
            const m = c * p - d * h;
            if (m <= 0 && h - c >= 0 && d - p >= 0) return Ct.subVectors(r, n), s = (h - c) / (h - c + (d - p)), t.copy(n).addScaledVector(Ct, s);
            const g = 1 / (m + f + u);
            return a = f * g, s = u * g, t.copy(i).addScaledVector(Et, a).addScaledVector(At, s)
        }
    ...
    class Nt extends U {
        constructor() {
            super(), this.isMaterial = !0, Object.defineProperty(this, "id", {value: It++}), this.uuid = G(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = l, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = z, this.stencilZFail = z, this.stencilZPass = z, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0
        }
    ...
    const Ot = new xe, Ft = new X;

    class Ut {
        constructor(e, t, i) {
            if (Array.isArray(e)) throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
            this.isBufferAttribute = !0, this.name = "", this.array = e, this.itemSize = t, this.count = void 0 !== e ? e.length / t : 0, this.normalized = !0 === i, this.usage = 35044, this.updateRange = {
                offset: 0,
                count: -1
            }, this.version = 0
        }
        ...
        copyColorsArray(e) {
            ...
            for (let n = 0, r = e.length; n < r; n++) {
                let r = e[n];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyColorsArray(): color is undefined", n), r = new oe), t[i++] = r.r, t[i++] = r.g, t[i++] = r.b
            }
            return this
        }
        ...
        copyVector2sArray(e) {
            ...
            for (let n = 0, r = e.length; n < r; n++) {
                let r = e[n];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyVector2sArray(): vector is undefined", n), r = new X), t[i++] = r.x, t[i++] = r.y
            }
            return this
        }
        ...
        copyVector3sArray(e) {
            ...
            for (let n = 0, r = e.length; n < r; n++) {
                let r = e[n];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyVector3sArray(): vector is undefined", n), r = new xe), t[i++] = r.x, t[i++] = r.y, t[i++] = r.z
            }
            return this
        }
        ...
        copyVector4sArray(e) {
            ...
            for (let n = 0, r = e.length; n < r; n++) {
                let r = e[n];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyVector4sArray(): vector is undefined", n), r = new fe), t[i++] = r.x, t[i++] = r.y, t[i++] = r.z, t[i++] = r.w
            }
            return this
        }

        applyMatrix3(e) {
            if (2 === this.itemSize) for (let t = 0, i = this.count; t < i; t++) Ft.fromBufferAttribute(this, t), Ft.applyMatrix3(e), this.setXY(t, Ft.x, Ft.y); else if (3 === this.itemSize) for (let t = 0, i = this.count; t < i; t++) Ot.fromBufferAttribute(this, t), Ot.applyMatrix3(e), this.setXYZ(t, Ot.x, Ot.y, Ot.z);
            return this
        }
    ...
    let Gt = 0;
    const Vt = new Ke, Wt = new Mt, jt = new xe, qt = new be, Xt = new be, Yt = new xe;

    class Zt extends U {
        constructor() {
            super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", {value: Gt++}), this.uuid = G(), this.name = "", this.type = "BufferGeometry", this.index = null, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
                start: 0,
                count: 1 / 0
            }, this.userData = {}
        }
        ...
        setIndex(e) {
            return Array.isArray(e) ? this.index = new (Z(e) ? Bt : kt)(e, 1) : this.index = e, this
        }
        ...
        lookAt(e) {
            return Wt.lookAt(e), Wt.updateMatrix(), this.applyMatrix4(Wt.matrix), this
        }
        ...
        computeBoundingBox() {
            null === this.boundingBox && (this.boundingBox = new be);
            const e = this.attributes.position, t = this.morphAttributes.position;
            if (e && e.isGLBufferAttribute) return console.error('THREE.BufferGeometry.computeBoundingBox(): GLBufferAttribute requires a manual bounding box. Alternatively set "mesh.frustumCulled" to "false".', this), void this.boundingBox.set(new xe(-1 / 0, -1 / 0, -1 / 0), new xe(1 / 0, 1 / 0, 1 / 0));
            if (void 0 !== e) {
                if (this.boundingBox.setFromBufferAttribute(e), t) for (let e = 0, i = t.length; e < i; e++) {
                    const i = t[e];
                    qt.setFromBufferAttribute(i), this.morphTargetsRelative ? (Yt.addVectors(this.boundingBox.min, qt.min), this.boundingBox.expandByPoint(Yt), Yt.addVectors(this.boundingBox.max, qt.max), this.boundingBox.expandByPoint(Yt)) : (this.boundingBox.expandByPoint(qt.min), this.boundingBox.expandByPoint(qt.max))
                }
        ...
        computeBoundingSphere() {
            ...
            const e = this.attributes.position, t = this.morphAttributes.position;
            if (e && e.isGLBufferAttribute) return console.error('THREE.BufferGeometry.computeBoundingSphere(): GLBufferAttribute requires a manual bounding sphere. Alternatively set "mesh.frustumCulled" to "false".', this), void this.boundingSphere.set(new xe, 1 / 0);
            if (e) {
                const i = this.boundingSphere.center;
                if (qt.setFromBufferAttribute(e), t) for (let e = 0, i = t.length; e < i; e++) {
                    const i = t[e];
                    Xt.setFromBufferAttribute(i), this.morphTargetsRelative ? (Yt.addVectors(qt.min, Xt.min), qt.expandByPoint(Yt), Yt.addVectors(qt.max, Xt.max), qt.expandByPoint(Yt)) : (qt.expandByPoint(Xt.min), qt.expandByPoint(Xt.max))
                }
                qt.getCenter(i);
                let n = 0;
                for (let t = 0, r = e.count; t < r; t++) Yt.fromBufferAttribute(e, t), n = Math.max(n, i.distanceToSquared(Yt));
                if (t) for (let r = 0, a = t.length; r < a; r++) {
                    const a = t[r], s = this.morphTargetsRelative;
                    for (let t = 0, r = a.count; t < r; t++) Yt.fromBufferAttribute(a, t), s && (jt.fromBufferAttribute(e, t), Yt.add(jt)), n = Math.max(n, i.distanceToSquared(Yt))
                }
        ...
        computeTangents() {
            ...
            !1 === this.hasAttribute("tangent") && this.setAttribute("tangent", new Ut(new Float32Array(4 * s), 4));
            const o = this.getAttribute("tangent").array, l = [], c = [];
            for (let e = 0; e < s; e++) l[e] = new xe, c[e] = new xe;
            const h = new xe, u = new xe, d = new xe, p = new X, f = new X, m = new X, g = new xe, v = new xe;
            ...
            for (let e = 0, t = x.length; e < t; ++e) {
                const t = x[e], n = t.start;
                for (let e = n, r = n + t.count; e < r; e += 3) _(i[e + 0], i[e + 1], i[e + 2])
            }
            const y = new xe, M = new xe, b = new xe, S = new xe;
        ...
        computeVertexNormals() {
            ...
            if (void 0 !== t) {
                ...
                if (void 0 === i) i = new Ut(new Float32Array(3 * t.count), 3), this.setAttribute("normal", i); else for (let e = 0, t = i.count; e < t; e++) i.setXYZ(e, 0, 0, 0);
                const n = new xe, r = new xe, a = new xe, s = new xe, o = new xe, l = new xe, c = new xe, h = new xe;
    ...
    const Kt = new Ke, Jt = new Ze, Qt = new He, $t = new xe, ei = new xe, ti = new xe, ii = new xe, ni = new xe,
        ri = new xe, ai = new xe, si = new xe, oi = new xe, li = new X, ci = new X, hi = new X, ui = new xe,
        di = new xe;
    ...
    class pi extends Mt {
        ...
        raycast(e, t) {
            ...
            if (void 0 === n) return;
            if (null === i.boundingSphere && i.computeBoundingSphere(), Qt.copy(i.boundingSphere), Qt.applyMatrix4(r), !1 === e.ray.intersectsSphere(Qt)) return;
            if (Kt.copy(r).invert(), Jt.copy(e.ray).applyMatrix4(Kt), null !== i.boundingBox && !1 === Jt.intersectsBox(i.boundingBox)) return;
            let a;
            const s = i.index, o = i.attributes.position, l = i.morphAttributes.position, c = i.morphTargetsRelative,
                h = i.attributes.uv, u = i.attributes.uv2, d = i.groups, p = i.drawRange;
            if (null !== s) if (Array.isArray(n)) for (let i = 0, r = d.length; i < r; i++) {
                ...
                for (let i = Math.max(r.start, p.start), n = Math.min(s.count, Math.min(r.start + r.count, p.start + p.count)); i < n; i += 3) {
                    ...
                    a = fi(this, f, e, Jt, o, l, c, h, u, n, d, p), a && (a.faceIndex = Math.floor(i / 3), a.face.materialIndex = r.materialIndex, t.push(a))
                }
            } else {
                for (let i = Math.max(0, p.start), r = Math.min(s.count, p.start + p.count); i < r; i += 3) {
                    const r = s.getX(i), d = s.getX(i + 1), p = s.getX(i + 2);
                    a = fi(this, n, e, Jt, o, l, c, h, u, r, d, p), a && (a.faceIndex = Math.floor(i / 3), t.push(a))
                }
            } else if (void 0 !== o) if (Array.isArray(n)) for (let i = 0, r = d.length; i < r; i++) {
                ...
                for (let i = Math.max(r.start, p.start), n = Math.min(o.count, Math.min(r.start + r.count, p.start + p.count)); i < n; i += 3) {
                    a = fi(this, s, e, Jt, o, l, c, h, u, i, i + 1, i + 2), a && (a.faceIndex = Math.floor(i / 3), a.face.materialIndex = r.materialIndex, t.push(a))
                }
            } else {
                for (let i = Math.max(0, p.start), r = Math.min(o.count, p.start + p.count); i < r; i += 3) {
                    a = fi(this, n, e, Jt, o, l, c, h, u, i, i + 1, i + 2), a && (a.faceIndex = Math.floor(i / 3), t.push(a))
                }
            }
        }
    }

    function fi(e, t, i, n, r, a, s, o, l, c, h, u) {
        $t.fromBufferAttribute(r, c), ei.fromBufferAttribute(r, h), ti.fromBufferAttribute(r, u);
        const d = e.morphTargetInfluences;
        if (a && d) {
            ai.set(0, 0, 0), si.set(0, 0, 0), oi.set(0, 0, 0);
            for (let e = 0, t = a.length; e < t; e++) {
                const t = d[e], i = a[e];
                0 !== t && (ii.fromBufferAttribute(i, c), ni.fromBufferAttribute(i, h), ri.fromBufferAttribute(i, u), s ? (ai.addScaledVector(ii, t), si.addScaledVector(ni, t), oi.addScaledVector(ri, t)) : (ai.addScaledVector(ii.sub($t), t), si.addScaledVector(ni.sub(ei), t), oi.addScaledVector(ri.sub(ti), t)))
            }
            $t.add(ai), ei.add(si), ti.add(oi)
        }
        e.isSkinnedMesh && (e.boneTransform(c, $t), e.boneTransform(h, ei), e.boneTransform(u, ti));
        const p = function (e, t, i, n, r, a, s, o) {
            ...
            di.copy(o), di.applyMatrix4(e.matrixWorld);
            const c = i.ray.origin.distanceTo(di);
            return c < i.near || c > i.far ? null : {distance: c, point: di.clone(), object: e}
        }(e, t, i, n, $t, ei, ti, ui);
        if (p) {
            o && (li.fromBufferAttribute(o, c), ci.fromBufferAttribute(o, h), hi.fromBufferAttribute(o, u), p.uv = Dt.getUV(ui, $t, ei, ti, li, ci, hi, new X)), l && (li.fromBufferAttribute(l, c), ci.fromBufferAttribute(l, h), hi.fromBufferAttribute(l, u), p.uv2 = Dt.getUV(ui, $t, ei, ti, li, ci, hi, new X));
            const e = {a: c, b: h, c: u, normal: new xe, materialIndex: 0};
            Dt.getNormal($t, ei, ti, e.normal), p.face = e
        }
        return p
    }
    ...
    class mi extends Zt {
        constructor(e = 1, t = 1, i = 1, n = 1, r = 1, a = 1) {
            ...
            function p(e, t, i, n, r, a, p, f, m, g, v) {
                const _ = a / m, x = p / g, y = a / 2, M = p / 2, b = f / 2, S = m + 1, w = g + 1;
                let T = 0, E = 0;
                const A = new xe;
                for (let a = 0; a < w; a++) {
                    const s = a * x - M;
                ...
                for (let e = 0; e < g; e++) for (let t = 0; t < m; t++) {
                    const i = u + t + S * e, n = u + t + S * (e + 1), r = u + (t + 1) + S * (e + 1),
                        a = u + (t + 1) + S * e;
            ...
            p("z", "y", "x", -1, -1, i, t, e, a, r, 0), p("z", "y", "x", 1, -1, i, t, -e, a, r, 1), p("x", "z", "y", 1, 1, e, i, t, n, a, 2), p("x", "z", "y", 1, -1, e, i, -t, n, a, 3), p("x", "y", "z", 1, -1, e, t, i, n, r, 4), p("x", "y", "z", -1, -1, e, t, -i, n, r, 5), this.setIndex(o), this.setAttribute("position", new Ht(l, 3)), this.setAttribute("normal", new Ht(c, 3)), this.setAttribute("uv", new Ht(h, 2))
        }
    ...
    class Mi extends yi {
        ...
        getFocalLength() {
            const e = Math.tan(.5 * B * this.fov);
            return .5 * this.getFilmHeight() / e
        }

        getEffectiveFOV() {
            return 2 * H * Math.atan(Math.tan(.5 * B * this.fov) / this.zoom)
        }
        ...
        updateProjectionMatrix() {
            const e = this.near;
            let t = e * Math.tan(.5 * B * this.fov) / this.zoom, i = 2 * t, n = this.aspect * i, r = -.5 * n;
            const a = this.view;
    ...
    class Si extends Mt {
        constructor(e, t, i) {
            ...
            this.renderTarget = i;
            const n = new Mi(bi, 1, e, t);
            n.layers = this.layers, n.up.set(0, -1, 0), n.lookAt(new xe(1, 0, 0)), this.add(n);
            const r = new Mi(bi, 1, e, t);
            r.layers = this.layers, r.up.set(0, -1, 0), r.lookAt(new xe(-1, 0, 0)), this.add(r);
            const a = new Mi(bi, 1, e, t);
            a.layers = this.layers, a.up.set(0, 0, 1), a.lookAt(new xe(0, 1, 0)), this.add(a);
            const s = new Mi(bi, 1, e, t);
            s.layers = this.layers, s.up.set(0, 0, -1), s.lookAt(new xe(0, -1, 0)), this.add(s);
            const o = new Mi(bi, 1, e, t);
            o.layers = this.layers, o.up.set(0, -1, 0), o.lookAt(new xe(0, 0, 1)), this.add(o);
            const l = new Mi(bi, 1, e, t);
            l.layers = this.layers, l.up.set(0, -1, 0), l.lookAt(new xe(0, 0, -1)), this.add(l)
        }

        update(e, t) {
            null === this.parent && this.updateMatrixWorld();
            const i = this.renderTarget, [n, r, a, s, o, l] = this.children, c = e.getRenderTarget(), h = e.toneMapping,
                u = e.xr.enabled;
    ...
    class Ti extends me {
        constructor(e, t = {}) {
            ...
            this.texture = new wi(n, t.mapping, t.wrapS, t.wrapT, t.magFilter, t.minFilter, t.format, t.type, t.anisotropy, t.encoding), this.texture.isRenderTargetTexture = !0, this.texture.generateMipmaps = void 0 !== t.generateMipmaps && t.generateMipmaps, this.texture.minFilter = void 0 !== t.minFilter ? t.minFilter : v
        }
        ...
        fromEquirectangularTexture(e, t) {
            ...
            const a = new pi(n, r), s = t.minFilter;
            t.minFilter === _ && (t.minFilter = v);
            return new Si(1, 10, this).update(e, a), t.minFilter = s, a.geometry.dispose(), a.material.dispose(), this
        }
    ...
    const Ei = new xe, Ai = new xe, Ci = new Y;
    ...
    class Li {
        ...
        setFromCoplanarPoints(e, t, i) {
            const n = Ei.subVectors(i, t).cross(Ai.subVectors(e, t)).normalize();
        ...
        intersectLine(e, t) {
            const i = e.delta(Ei), n = this.normal.dot(i);
        ...
        applyMatrix4(e, t) {
            const i = t || Ci.getNormalMatrix(e), n = this.coplanarPoint(Ei).applyMatrix4(e),
    ...
    const Pi = new He, Ri = new xe;

    class Di {
        constructor(e = new Li, t = new Li, i = new Li, n = new Li, r = new Li, a = new Li) {
        ...
        setFromProjectionMatrix(e) {
            const t = this.planes, i = e.elements, n = i[0], r = i[1], a = i[2], s = i[3], o = i[4], l = i[5], c = i[6],
                h = i[7], u = i[8], d = i[9], p = i[10], f = i[11], m = i[12], g = i[13], v = i[14], _ = i[15];
        ...
        intersectsObject(e) {
            const t = e.geometry;
            return null === t.boundingSphere && t.computeBoundingSphere(), Pi.copy(t.boundingSphere).applyMatrix4(e.matrixWorld), this.intersectsSphere(Pi)
        }
        ...
        intersectsBox(e) {
            ...
            for (let i = 0; i < 6; i++) {
                const n = t[i];
                if (Ri.x = n.normal.x > 0 ? e.max.x : e.min.x, Ri.y = n.normal.y > 0 ? e.max.y : e.min.y, Ri.z = n.normal.z > 0 ? e.max.z : e.min.z, n.distanceToPoint(Ri) < 0) return !1
            }
            return !0
        }
        ...
        return {
            get: function (e) {
                ...
                void 0 === a ? n.set(t, function (t, n) {
                    ...
                    let o;
                    if (e.bindBuffer(n, s), e.bufferData(n, r, a), t.onUploadCallback(), r instanceof Float32Array) o = 5126; else if (r instanceof Uint16Array) if (t.isFloat16BufferAttribute) {
    ...
    class zi extends Zt {
        constructor(e = 1, t = 1, i = 1, n = 1) {
            ...
            this.setIndex(d), this.setAttribute("position", new Ht(p, 3)), this.setAttribute("normal", new Ht(f, 3)), this.setAttribute("uv", new Ht(m, 2))
        }
    ...
    const Oi = {
        ...
        basic: {
            uniforms: vi([Fi.common, Fi.specularmap, Fi.envmap, Fi.aomap, Fi.lightmap, Fi.fog]),
            vertexShader: Oi.meshbasic_vert,
            fragmentShader: Oi.meshbasic_frag
        },
        lambert: {
            uniforms: vi([Fi.common, Fi.specularmap, Fi.envmap, Fi.aomap, Fi.lightmap, Fi.emissivemap, Fi.fog, Fi.lights, {emissive: {value: new oe(0)}}]),
            vertexShader: Oi.meshlambert_vert,
            fragmentShader: Oi.meshlambert_frag
        },
        phong: {
            uniforms: vi([Fi.common, Fi.specularmap, Fi.envmap, Fi.aomap, Fi.lightmap, Fi.emissivemap, Fi.bumpmap, Fi.normalmap, Fi.displacementmap, Fi.fog, Fi.lights, {
                emissive: {value: new oe(0)},
                specular: {value: new oe(1118481)},
                shininess: {value: 30}
            }]), vertexShader: Oi.meshphong_vert, fragmentShader: Oi.meshphong_frag
        },
        standard: {
            uniforms: vi([Fi.common, Fi.envmap, Fi.aomap, Fi.lightmap, Fi.emissivemap, Fi.bumpmap, Fi.normalmap, Fi.displacementmap, Fi.roughnessmap, Fi.metalnessmap, Fi.fog, Fi.lights, {
                emissive: {value: new oe(0)},
                roughness: {value: 1},
                metalness: {value: 0},
                envMapIntensity: {value: 1}
            }]), vertexShader: Oi.meshphysical_vert, fragmentShader: Oi.meshphysical_frag
        },
        toon: {
            uniforms: vi([Fi.common, Fi.aomap, Fi.lightmap, Fi.emissivemap, Fi.bumpmap, Fi.normalmap, Fi.displacementmap, Fi.gradientmap, Fi.fog, Fi.lights, {emissive: {value: new oe(0)}}]),
            vertexShader: Oi.meshtoon_vert,
            fragmentShader: Oi.meshtoon_frag
        },
        matcap: {
            uniforms: vi([Fi.common, Fi.bumpmap, Fi.normalmap, Fi.displacementmap, Fi.fog, {matcap: {value: null}}]),
            vertexShader: Oi.meshmatcap_vert,
            fragmentShader: Oi.meshmatcap_frag
        },
        points: {uniforms: vi([Fi.points, Fi.fog]), vertexShader: Oi.points_vert, fragmentShader: Oi.points_frag},
        dashed: {
            uniforms: vi([Fi.common, Fi.fog, {scale: {value: 1}, dashSize: {value: 1}, totalSize: {value: 2}}]),
            vertexShader: Oi.linedashed_vert,
            fragmentShader: Oi.linedashed_frag
        },
        depth: {
            uniforms: vi([Fi.common, Fi.displacementmap]),
            vertexShader: Oi.depth_vert,
            fragmentShader: Oi.depth_frag
        },
        normal: {
            uniforms: vi([Fi.common, Fi.bumpmap, Fi.normalmap, Fi.displacementmap, {opacity: {value: 1}}]),
            vertexShader: Oi.meshnormal_vert,
            fragmentShader: Oi.meshnormal_frag
        },
        sprite: {uniforms: vi([Fi.sprite, Fi.fog]), vertexShader: Oi.sprite_vert, fragmentShader: Oi.sprite_frag},
        background: {
        ...
        cube: {
            uniforms: vi([Fi.envmap, {opacity: {value: 1}}]),
        ...
        distanceRGBA: {
            ...
            }]), vertexShader: Oi.distanceRGBA_vert, fragmentShader: Oi.distanceRGBA_frag
        },
        shadow: {
            uniforms: vi([Fi.lights, Fi.fog, {color: {value: new oe(0)}, opacity: {value: 1}}]),
    ...
    function ki(e, t, i, n, r, a) {
        const s = new oe(0);
        let o, l, c = !0 === r ? 0 : 1, h = null, u = 0, p = null;
        ...
        return {
            getClearColor: function () {
                ...
                const g = e.xr, v = g.getSession && g.getSession();
                v && "additive" === v.environmentBlendMode && (m = null), null === m ? f(s, c) : m && m.isColor && (f(m, 1), a = !0), (e.autoClear || a) && e.clear(e.autoClearColor, e.autoClearDepth, e.autoClearStencil), m && (m.isCubeTexture || m.mapping === d) ? (void 0 === l && (l = new pi(new mi(1, 1, 1), new xi({
                    name: "BackgroundCubeMaterial",
                    uniforms: gi(Ui.cube.uniforms),
    ...
    function Bi(e, t, i, n) {
        const r = e.getParameter(34921), a = n.isWebGL2 ? null : t.get("OES_vertex_array_object"),
            s = n.isWebGL2 || null !== a, o = {}, l = p(null);
        let c = l, h = !1;
    ...
    function Vi(e) {
        ...
        const s = new Li, o = new Y, l = {value: null, needsUpdate: !1};
    ...
    Ui.physical = {
        uniforms: vi([Ui.standard.uniforms, {
            clearcoat: {value: 0},
    ...
    const qi = [.125, .215, .35, .446, .526, .582], Xi = 20, Yi = new ji, Zi = new oe;
    let Ki = null;
    const Ji = (1 + Math.sqrt(5)) / 2, Qi = 1 / Ji,
        $i = [new xe(1, 1, 1), new xe(-1, 1, 1), new xe(1, 1, -1), new xe(-1, 1, -1), new xe(0, Ji, Qi), new xe(0, Ji, -Qi), new xe(Qi, 0, Ji), new xe(-Qi, 0, Ji), new xe(Ji, Qi, 0), new xe(-Ji, Qi, 0)];
    ...
    class en {
        ...
        compileCubemapShader() {
            null === this._cubemapMaterial && (this._cubemapMaterial = an(), this._compileMaterial(this._cubemapMaterial))
        }

        compileEquirectangularShader() {
            null === this._equirectMaterial && (this._equirectMaterial = rn(), this._compileMaterial(this._equirectMaterial))
        }
        ...
        _cleanup(e) {
            this._renderer.setRenderTarget(Ki), e.scissorTest = !1, nn(e, 0, 0, e.width, e.height)
        }
        ...
        _allocateTargets() {
            const e = 3 * Math.max(this._cubeSize, 112), t = 4 * this._cubeSize,
                i = {magFilter: v, minFilter: v, generateMipmaps: !1, type: b, format: w, encoding: R, depthBuffer: !1},
                n = tn(e, t, i);
            if (null === this._pingPongRenderTarget || this._pingPongRenderTarget.width !== e) {
                null !== this._pingPongRenderTarget && this._dispose(), this._pingPongRenderTarget = tn(e, t, i);
                const {_lodMax: n} = this;
                ({sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas} = function (e) {
                    const t = [], i = [], n = [];
                    let r = e;
                    const a = e - 4 + 1 + qi.length;
                    for (let s = 0; s < a; s++) {
                        const a = Math.pow(2, r);
                        i.push(a);
                        let o = 1 / a;
                        s > e - 4 ? o = qi[s - e + 4 - 1] : 0 === s && (o = 0), n.push(o);
                        const l = 1 / (a - 2), c = -l, h = 1 + l, u = [c, c, h, c, h, h, c, c, h, h, c, h], d = 6,
                            p = 6, f = 3, m = 2, g = 1, v = new Float32Array(f * p * d),
                            _ = new Float32Array(m * p * d), x = new Float32Array(g * p * d);
                        for (let e = 0; e < d; e++) {
                        ...
                        const y = new Zt;
                        y.setAttribute("position", new Ut(v, f)), y.setAttribute("uv", new Ut(_, m)), y.setAttribute("faceIndex", new Ut(x, g)), t.push(y), r > 4 && r--
                    }
                    return {lodPlanes: t, sizeLods: i, sigmas: n}
                }(n)), this._blurMaterial = function (e, t, i) {
                    const n = new Float32Array(Xi), r = new xe(0, 1, 0);
                    return new xi({
        ...
        _compileMaterial(e) {
            const t = new pi(this._lodPlanes[0], e);
            this._renderer.compile(t, Yi)
        }

        _sceneToCubeUV(e, t, i, n) {
            const r = new Mi(90, 1, t, i), a = [1, -1, 1, 1, 1, 1], s = [1, 1, 1, -1, -1, -1], o = this._renderer,
                l = o.autoClear, c = o.toneMapping;
            o.getClearColor(Zi), o.toneMapping = 0, o.autoClear = !1;
            const h = new zt({name: "PMREM.Background", side: 1, depthWrite: !1, depthTest: !1}), u = new pi(new mi, h);
            let d = !1;
            const p = e.background;
            p ? p.isColor && (h.color.copy(p), e.background = null, d = !0) : (h.color.copy(Zi), d = !0);
            for (let t = 0; t < 6; t++) {
                const i = t % 3;
                0 === i ? (r.up.set(0, a[t], 0), r.lookAt(s[t], 0, 0)) : 1 === i ? (r.up.set(0, 0, a[t]), r.lookAt(0, s[t], 0)) : (r.up.set(0, a[t], 0), r.lookAt(0, 0, s[t]));
                const l = this._cubeSize;
                nn(n, i * l, t > 2 ? l : 0, l, l), o.setRenderTarget(n), d && o.render(u, r), o.render(e, r)
            }
        ...
        _textureToCubeUV(e, t) {
            ...
            n ? (null === this._cubemapMaterial && (this._cubemapMaterial = an()), this._cubemapMaterial.uniforms.flipEnvMap.value = !1 === e.isRenderTargetTexture ? -1 : 1) : null === this._equirectMaterial && (this._equirectMaterial = rn());
            const r = n ? this._cubemapMaterial : this._equirectMaterial, a = new pi(this._lodPlanes[0], r);
            r.uniforms.envMap.value = e;
            const s = this._cubeSize;
            nn(t, 0, 0, 3 * s, 2 * s), i.setRenderTarget(t), i.render(a, Yi)
        }
        ...
        _halfBlur(e, t, i, n, r, a, s) {
            ...
            const c = new pi(this._lodPlanes[n], l), h = l.uniforms, u = this._sizeLods[i] - 1,
                d = isFinite(r) ? Math.PI / (2 * u) : 2 * Math.PI / 39, p = r / d,
                f = isFinite(r) ? 1 + Math.floor(3 * p) : Xi;
            f > Xi && console.warn(`sigmaRadians, ${r}, is too large and will clip, as it requested ${f} samples when the maximum is set to 20`);
            const m = [];
            let g = 0;
            for (let e = 0; e < Xi; ++e) {
            ...
            nn(t, 3 * _ * (n > v - 4 ? n - v + 4 : 0), 4 * (this._cubeSize - _), 3 * _, 2 * _), o.setRenderTarget(t), o.render(c, Yi)
        }
    }

    function tn(e, t, i) {
        const n = new me(e, t, i);
    ...
    function on(e) {
        ...
        return {
            get: function (r) {
                if (r && r.isTexture) {
                    const a = r.mapping, s = a === u || 304 === a, o = a === c || a === h;
                    if (s || o) {
                        if (r.isRenderTargetTexture && !0 === r.needsPMREMUpdate) {
                            r.needsPMREMUpdate = !1;
                            let n = t.get(r);
                            return null === i && (i = new en(e)), n = s ? i.fromEquirectangular(r, n) : i.fromCubemap(r, n), t.set(r, n), n.texture
                        }
    ...
    function mn(e, t, i) {
        const n = {}, r = new Float32Array(8), a = new WeakMap, s = new fe, o = [];
            ...
            update: function (l, c, h, u) {
                ...
                if (!0 === t.isWebGL2) {
                    ...
                    if (void 0 === m || m.count !== f) {
                        ...
                        const _ = void 0 !== c.morphAttributes.position, x = void 0 !== c.morphAttributes.normal,
                            y = void 0 !== c.morphAttributes.color, b = c.morphAttributes.position || [],
                            S = c.morphAttributes.normal || [], w = c.morphAttributes.color || [];
                        let T = 0;
                        ...
                        const C = new Float32Array(E * A * 4 * f), L = new ge(C, E, A, f);
                        L.type = M, L.needsUpdate = !0;
                        const P = 4 * T;
                        for (let D = 0; D < f; D++) {
                            const I = b[D], N = S[D], z = w[D], O = E * A * 4 * D;
                            for (let F = 0; F < I.count; F++) {
                                const U = F * P;
                                !0 === _ && (s.fromBufferAttribute(I, F), !0 === I.normalized && fn(s, I), C[O + U + 0] = s.x, C[O + U + 1] = s.y, C[O + U + 2] = s.z, C[O + U + 3] = 0), !0 === x && (s.fromBufferAttribute(N, F), !0 === N.normalized && fn(s, N), C[O + U + 4] = s.x, C[O + U + 5] = s.y, C[O + U + 6] = s.z, C[O + U + 7] = 0), !0 === y && (s.fromBufferAttribute(z, F), !0 === z.normalized && fn(s, z), C[O + U + 8] = s.x, C[O + U + 9] = s.y, C[O + U + 10] = s.z, C[O + U + 11] = 4 === z.itemSize ? s.w : 1)
                            }
                        }
                        ...
                        m = {count: f, texture: L, size: new X(E, A)}, a.set(c, m), c.addEventListener("dispose", R)
                    }
                    let g = 0;
                    for (let k = 0; k < d.length; k++) g += d[k];
                    ...
                    H.sort(pn);
                    for (let K = 0; K < 8; K++) K < B && H[K][1] ? (o[K][0] = H[K][0], o[K][1] = H[K][1]) : (o[K][0] = Number.MAX_SAFE_INTEGER, o[K][1] = 0);
                    o.sort(dn);
                    const G = c.morphAttributes.position, V = c.morphAttributes.normal;
                    let W = 0;
                    for (let J = 0; J < 8; J++) {
                        const Q = o[J], $ = Q[0], ee = Q[1];
                        $ !== Number.MAX_SAFE_INTEGER && ee ? (G && c.getAttribute("morphTarget" + J) !== G[$] && c.setAttribute("morphTarget" + J, G[$]), V && c.getAttribute("morphNormal" + J) !== V[$] && c.setAttribute("morphNormal" + J, V[$]), r[J] = ee, W += ee) : (G && !0 === c.hasAttribute("morphTarget" + J) && c.deleteAttribute("morphTarget" + J), V && !0 === c.hasAttribute("morphNormal" + J) && c.deleteAttribute("morphNormal" + J), r[J] = 0)
                    }
    ...
    const vn = new pe, _n = new ge, xn = new ve, yn = new wi, Mn = [], bn = [], Sn = new Float32Array(16),
        wn = new Float32Array(9), Tn = new Float32Array(4);
    ...
    function En(e, t, i) {
        ...
        const r = t * i;
        let a = Mn[r];
        if (void 0 === a && (a = new Float32Array(r), Mn[r] = a), 0 !== t) {
            n.toArray(a, 0);
    ...
    function Rn(e, t) {
        ...
        if (void 0 !== t.x) i[0] === t.x && i[1] === t.y || (e.uniform2f(this.addr, t.x, t.y), i[0] = t.x, i[1] = t.y); else {
            if (An(i, t)) return;
            e.uniform2fv(this.addr, t), Cn(i, t)
        }
    }
    ...
    function Dn(e, t) {
        ...
        if (void 0 !== t.x) i[0] === t.x && i[1] === t.y && i[2] === t.z || (e.uniform3f(this.addr, t.x, t.y, t.z), i[0] = t.x, i[1] = t.y, i[2] = t.z); else if (void 0 !== t.r) i[0] === t.r && i[1] === t.g && i[2] === t.b || (e.uniform3f(this.addr, t.r, t.g, t.b), i[0] = t.r, i[1] = t.g, i[2] = t.b); else {
            if (An(i, t)) return;
            e.uniform3fv(this.addr, t), Cn(i, t)
        }
    }
    ...
    function In(e, t) {
        ...
        if (void 0 !== t.x) i[0] === t.x && i[1] === t.y && i[2] === t.z && i[3] === t.w || (e.uniform4f(this.addr, t.x, t.y, t.z, t.w), i[0] = t.x, i[1] = t.y, i[2] = t.z, i[3] = t.w); else {
            if (An(i, t)) return;
            e.uniform4fv(this.addr, t), Cn(i, t)
        }
    }
    ...
    function Nn(e, t) {
        ...
        if (void 0 === n) {
            if (An(i, t)) return;
            e.uniformMatrix2fv(this.addr, !1, t), Cn(i, t)
        } else {
            if (An(i, n)) return;
            Tn.set(n), e.uniformMatrix2fv(this.addr, !1, Tn), Cn(i, n)
        }
    }
    ...
    function zn(e, t) {
        ...
        if (void 0 === n) {
            if (An(i, t)) return;
            e.uniformMatrix3fv(this.addr, !1, t), Cn(i, t)
        } else {
            if (An(i, n)) return;
            wn.set(n), e.uniformMatrix3fv(this.addr, !1, wn), Cn(i, n)
        }
    }
    ...
    function On(e, t) {
        ...
        if (void 0 === n) {
            if (An(i, t)) return;
            e.uniformMatrix4fv(this.addr, !1, t), Cn(i, t)
        } else {
            if (An(i, n)) return;
            Sn.set(n), e.uniformMatrix4fv(this.addr, !1, Sn), Cn(i, n)
        }
    }
    ...
    function Un(e, t) {
        const i = this.cache;
        An(i, t) || (e.uniform2iv(this.addr, t), Cn(i, t))
    }

    function kn(e, t) {
        const i = this.cache;
        An(i, t) || (e.uniform3iv(this.addr, t), Cn(i, t))
    }

    function Bn(e, t) {
        const i = this.cache;
        An(i, t) || (e.uniform4iv(this.addr, t), Cn(i, t))
    }
    ...
    function Gn(e, t) {
        const i = this.cache;
        An(i, t) || (e.uniform2uiv(this.addr, t), Cn(i, t))
    }

    function Vn(e, t) {
        const i = this.cache;
        An(i, t) || (e.uniform3uiv(this.addr, t), Cn(i, t))
    }

    function Wn(e, t) {
        const i = this.cache;
        An(i, t) || (e.uniform4uiv(this.addr, t), Cn(i, t))
    }

    function jn(e, t, i) {
        const n = this.cache, r = i.allocateTextureUnit();
        n[0] !== r && (e.uniform1i(this.addr, r), n[0] = r), i.setTexture2D(t || vn, r)
    }

    function qn(e, t, i) {
        const n = this.cache, r = i.allocateTextureUnit();
        n[0] !== r && (e.uniform1i(this.addr, r), n[0] = r), i.setTexture3D(t || xn, r)
    }

    function Xn(e, t, i) {
        const n = this.cache, r = i.allocateTextureUnit();
        n[0] !== r && (e.uniform1i(this.addr, r), n[0] = r), i.setTextureCube(t || yn, r)
    }

    function Yn(e, t, i) {
        const n = this.cache, r = i.allocateTextureUnit();
        n[0] !== r && (e.uniform1i(this.addr, r), n[0] = r), i.setTexture2DArray(t || _n, r)
    }
    ...
    function Kn(e, t) {
        const i = En(t, this.size, 2);
        e.uniform2fv(this.addr, i)
    }

    function Jn(e, t) {
        const i = En(t, this.size, 3);
        e.uniform3fv(this.addr, i)
    }

    function Qn(e, t) {
        const i = En(t, this.size, 4);
    ...
    function er(e, t) {
        const i = En(t, this.size, 9);
        e.uniformMatrix3fv(this.addr, !1, i)
    }

    function tr(e, t) {
        const i = En(t, this.size, 16);
    ...
    function hr(e, t, i) {
        ...
        for (let e = 0; e !== n; ++e) i.setTexture2D(t[e] || vn, r[e])
    }

    function ur(e, t, i) {
        const n = t.length, r = Ln(i, n);
        e.uniform1iv(this.addr, r);
        for (let e = 0; e !== n; ++e) i.setTexture3D(t[e] || xn, r[e])
    }

    function dr(e, t, i) {
        const n = t.length, r = Ln(i, n);
        e.uniform1iv(this.addr, r);
        for (let e = 0; e !== n; ++e) i.setTextureCube(t[e] || yn, r[e])
    }

    function pr(e, t, i) {
        const n = t.length, r = Ln(i, n);
        e.uniform1iv(this.addr, r);
        for (let e = 0; e !== n; ++e) i.setTexture2DArray(t[e] || _n, r[e])
    }
    ...
    function xr(e, t, i) {
        ...
        for (vr.lastIndex = 0; ;) {
            const a = vr.exec(n), s = vr.lastIndex;
            let o = a[1];
            const l = "]" === a[2], c = a[3];
            if (l && (o |= 0), void 0 === c || "[" === c && s + 2 === r) {
                _r(i, void 0 === c ? new fr(o, e, t) : new mr(o, e, t));
                break
            }
            {
                let e = i.map[o];
                void 0 === e && (e = new gr(o), _r(i, e)), i = e
            }
        }
    }
    ...
    class yr {
        constructor(e, t) {
            ...
            for (let n = 0; n < i; ++n) {
                ...
                xr(i, e.getUniformLocation(t, i.name), this)
            }
        }
    ...
    function Nr(e) {
        return e.replace(Ir, Or).replace(Dr, zr)
    }

    function zr(e, t, i, n) {
        return console.warn("WebGLProgram: #pragma unroll_loop shader syntax is deprecated. Please use #pragma unroll_loop_start syntax instead."), Or(e, t, i, n)
    }
    ...
    function Ur(e, t, i, n) {
        ...
        if (r.attachShader(_, S), r.attachShader(_, w), void 0 !== i.index0AttributeName ? r.bindAttribLocation(_, 0, i.index0AttributeName) : !0 === i.morphTargets && r.bindAttribLocation(_, 0, "position"), r.linkProgram(_), e.debug.checkShaderErrors) {
            const e = r.getProgramInfoLog(_).trim(), t = r.getShaderInfoLog(S).trim(), i = r.getShaderInfoLog(w).trim();
            let n = !0, a = !0;
            if (!1 === r.getProgramParameter(_, 35714)) {
                n = !1;
                const t = Sr(r, S, "vertex"), i = Sr(r, w, "fragment");
        ...
        return r.deleteShader(S), r.deleteShader(w), this.getUniforms = function () {
            return void 0 === T && (T = new yr(r, _)), T
        ...
        }, this.name = i.shaderName, this.id = br++, this.cacheKey = t, this.usedTimes = 1, this.program = _, this.vertexShader = S, this.fragmentShader = w, this
    }
    ...
    function Gr(e, t, i, n, r, a, s) {
        const o = new ot, l = new Br, c = [], h = r.isWebGL2, u = r.logarithmicDepthBuffer, p = r.vertexTextures;
        let f = r.precision;
        const m = {
        ...
        return {
            getParameters: function (a, o, c, g, v) {
                const _ = g.fog, x = v.geometry, y = a.isMeshStandardMaterial ? g.environment : null,
                    M = (a.isMeshStandardMaterial ? i : t).get(a.envMap || y),
                    b = M && M.mapping === d ? M.image.height : null, S = m[a.type];
                ...
                const I = e.getRenderTarget(), N = a.alphaTest > 0, z = a.clearcoat > 0, O = a.iridescence > 0;
                return {
                    isWebGL2: h,
                    shaderID: S,
                    shaderName: a.type,
                ...
                return void 0 === n && (n = new Ur(e, i, t, a), c.push(n)), n
    ...
    function qr() {
        ...
        return {
            opaque: i, transmissive: n, transparent: r, init: function () {
                ...
                i.length > 1 && i.sort(e || Wr), n.length > 1 && n.sort(t || jr), r.length > 1 && r.sort(t || jr)
            }
        }
    }
    ...
    function Xr() {
        ...
        return {
            get: function (t, i) {
                let n;
                return !1 === e.has(t) ? (n = new qr, e.set(t, [n])) : i >= e.get(t).length ? (n = new qr, e.get(t).push(n)) : n = e.get(t)[i], n
            }, dispose: function () {
                e = new WeakMap
            }
        }
            ...
            get: function (t) {
                ...
                switch (t.type) {
                    case"DirectionalLight":
                        i = {direction: new xe, color: new oe};
                        break;
                    case"SpotLight":
                        i = {
                            position: new xe,
                        ...
                        break;
                    case"PointLight":
                        i = {position: new xe, color: new oe, distance: 0, decay: 0};
                        break;
                    case"HemisphereLight":
                        i = {direction: new xe, skyColor: new oe, groundColor: new oe};
                        break;
                    case"RectAreaLight":
                        i = {color: new oe, position: new xe, halfWidth: new xe, halfHeight: new xe}
                }
                return e[t.id] = i, i
            }
        }
    ...
    function Jr(e, t) {
        ...
        const a = new xe, s = new Ke, o = new Ke;
        return {
            setup: function (a, s) {
                let o = 0, l = 0, c = 0;
                ...
                for (let e = 0, t = a.length; e < t; e++) {
                    const t = a[e], s = t.color, x = t.intensity, y = t.distance,
                        M = t.shadow && t.shadow.map ? t.shadow.map.texture : null;
                    if (t.isAmbientLight) o += s.r * x * _, l += s.g * x * _, c += s.b * x * _; else if (t.isLightProbe) for (let e = 0; e < 9; e++) r.probe[e].addScaledVector(t.sh.coefficients[e], x); else if (t.isDirectionalLight) {
                        const e = i.get(t);
    ...
    function $r(e, t) {
        ...
        return {
            get: function (n, r = 0) {
                let a;
                return !1 === i.has(n) ? (a = new Qr(e, t), i.set(n, [a])) : r >= i.get(n).length ? (a = new Qr(e, t), i.get(n).push(a)) : a = i.get(n)[r], a
            }, dispose: function () {
                i = new WeakMap
            }
        }
    ...
    class ta extends Nt {
        constructor(e) {
            super(), this.isMeshDistanceMaterial = !0, this.type = "MeshDistanceMaterial", this.referencePosition = new xe, this.nearDistance = 1, this.farDistance = 1e3, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.setValues(e)
        }
    ...
    function ia(e, t, i) {
        let n = new Di;
        const r = new X, a = new X, s = new fe, o = new ea({depthPacking: 3201}), l = new ta, c = {},
            h = i.maxTextureSize, u = {0: 1, 1: 0, 2: 2}, d = new xi({
        ...
        const f = new Zt;
        f.setAttribute("position", new Ut(new Float32Array([-1, -1, .5, 3, -1, .5, -1, 3, .5]), 3));
        const m = new pi(f, d), v = this;

        function _(i, n) {
            const a = t.update(m);
            d.defines.VSM_SAMPLES !== i.blurSamples && (d.defines.VSM_SAMPLES = i.blurSamples, p.defines.VSM_SAMPLES = i.blurSamples, d.needsUpdate = !0, p.needsUpdate = !0), null === i.mapPass && (i.mapPass = new me(r.x, r.y)), d.uniforms.shadow_pass.value = i.map.texture, d.uniforms.resolution.value = i.mapSize, d.uniforms.radius.value = i.radius, e.setRenderTarget(i.mapPass), e.clear(), e.renderBufferDirect(n, null, a, d, m, null), p.uniforms.shadow_pass.value = i.mapPass.texture, p.uniforms.resolution.value = i.mapSize, p.uniforms.radius.value = i.radius, e.setRenderTarget(i.map), e.clear(), e.renderBufferDirect(n, null, a, p, m, null)
        }
        ...
        this.enabled = !1, this.autoUpdate = !0, this.needsUpdate = !1, this.type = 1, this.render = function (t, i, o) {
            ...
            for (let l = 0, c = t.length; l < c; l++) {
                ...
                if (r.multiply(p), a.copy(u.mapSize), (r.x > h || r.y > h) && (r.x > h && (a.x = Math.floor(h / p.x), r.x = a.x * p.x, u.mapSize.x = a.x), r.y > h && (a.y = Math.floor(h / p.y), r.y = a.y * p.y, u.mapSize.y = a.y)), null === u.map) {
                    const e = 3 !== this.type ? {minFilter: g, magFilter: g} : {};
                    u.map = new me(r.x, r.y, e), u.map.texture.name = c.name + ".shadowMap", u.camera.updateProjectionMatrix()
                }
    ...
    function na(e, t, i) {
        ...
        let o = {}, c = {}, h = new WeakMap, u = [], d = null, p = !1, f = null, m = null, g = null, v = null, _ = null,
            x = null, y = null, M = !1, b = null, S = null, w = null, T = null, E = null;
        const A = e.getParameter(35661);
        let C = !1, L = 0;
        const P = e.getParameter(7938);
        -1 !== P.indexOf("WebGL") ? (L = parseFloat(/^WebGL (\d)/.exec(P)[1]), C = L >= 1) : -1 !== P.indexOf("OpenGL ES") && (L = parseFloat(/^OpenGL ES (\d)/.exec(P)[1]), C = L >= 2);
        let R = null, D = {};
        const I = e.getParameter(3088), N = e.getParameter(2978), z = (new fe).fromArray(I), O = (new fe).fromArray(N);
        ...
        U[3553] = F(3553, 3553, 1), U[34067] = F(34067, 34069, 6), r.setClear(0, 0, 0, 1), a.setClear(1), s.setClear(0), k(2929), a.setFunc(3), W(!1), j(1), k(2884), V(0);
        const H = {[l]: 32774, 101: 32778, 102: 32779};
        ...
        function V(t, i, n, r, a, s, o, c) {
            if (0 !== t) {
                if (!1 === p && (k(3042), p = !0), 5 === t) a = a || i, s = s || n, o = o || r, i === m && a === _ || (e.blendEquationSeparate(H[i], H[a]), m = i, _ = a), n === g && r === v && s === x && o === y || (e.blendFuncSeparate(G[n], G[r], G[s], G[o]), g = n, v = r, x = s, y = o), f = t, M = null; else if (t !== f || c !== M) {
        ...
        function j(t) {
            0 !== t ? (k(2884), t !== S && (1 === t ? e.cullFace(1029) : 2 === t ? e.cullFace(1028) : e.cullFace(1032))) : B(2884), S = t
        }

        function q(t, i, n) {
            t ? (k(32823), T === i && E === n || (e.polygonOffset(i, n), T = i, E = n)) : B(32823)
        }
        ...
        return {
            buffers: {color: r, depth: a, stencil: s}, enable: k, disable: B, bindFramebuffer: function (t, i) {
                return c[t] !== i && (e.bindFramebuffer(t, i), c[t] = i, n && (36009 === t && (c[36160] = i), 36160 === t && (c[36009] = i)), !0)
            }, drawBuffers: function (n, r) {
                let a = u, s = !1;
                if (n) if (a = h.get(r), void 0 === a && (a = [], h.set(r, a)), n.isWebGLMultipleRenderTargets) {
                    const e = n.texture;
            ...
            }, setBlending: V, setMaterial: function (e, t) {
            ...
            }, setPolygonOffset: q, setScissorTest: function (e) {
                e ? k(3089) : B(3089)
                ...
                void 0 === n && (n = {
                    type: void 0,
                    texture: void 0
                }, D[R] = n), n.type === t && n.texture === i || (e.bindTexture(t, i || U[t]), n.type = t, n.texture = i)
    ...
    function ra(e, t, i, n, r, a, s) {
        const o = r.isWebGL2, l = r.maxTextures, c = r.maxCubemapSize, h = r.maxTextureSize, u = r.maxSamples,
            ...
            A = /OculusBrowser/g.test(navigator.userAgent), C = new WeakMap;
        let L;
        const P = new WeakMap;
        let I = !1;
        try {
        ...
        function z(e, t, i, n) {
            ...
            if ((e.width > n || e.height > n) && (r = n / Math.max(e.width, e.height)), r < 1 || !0 === t) {
                if ("undefined" != typeof HTMLImageElement && e instanceof HTMLImageElement || "undefined" != typeof HTMLCanvasElement && e instanceof HTMLCanvasElement || "undefined" != typeof ImageBitmap && e instanceof ImageBitmap) {
                    const n = t ? q : Math.floor, a = n(r * e.width), s = n(r * e.height);
                    void 0 === L && (L = N(a, s));
                    const o = i ? N(a, s) : L;
        ...
        function V(e) {
            const t = e.target;
            t.removeEventListener("dispose", V), function (e) {
                const t = n.get(e);
                if (void 0 === t.__webglInit) return;
                const i = e.source, r = P.get(i);
                if (r) {
                    const n = r[t.__cacheKey];
                    n.usedTimes--, 0 === n.usedTimes && X(e), 0 === Object.keys(r).length && P.delete(i)
                }
                n.remove(e)
        ...
        function W(t) {
            const i = t.target;
            i.removeEventListener("dispose", W), function (t) {
                const i = t.texture, r = n.get(t), a = n.get(i);
                void 0 !== a.__webglTexture && (e.deleteTexture(a.__webglTexture), s.memory.textures--);
                t.depthTexture && t.depthTexture.dispose();
                if (t.isWebGLCubeRenderTarget) for (let t = 0; t < 6; t++) e.deleteFramebuffer(r.__webglFramebuffer[t]), r.__webglDepthbuffer && e.deleteRenderbuffer(r.__webglDepthbuffer[t]); else {
                    if (e.deleteFramebuffer(r.__webglFramebuffer), r.__webglDepthbuffer && e.deleteRenderbuffer(r.__webglDepthbuffer), r.__webglMultisampledFramebuffer && e.deleteFramebuffer(r.__webglMultisampledFramebuffer), r.__webglColorRenderbuffer) for (let t = 0; t < r.__webglColorRenderbuffer.length; t++) r.__webglColorRenderbuffer[t] && e.deleteRenderbuffer(r.__webglColorRenderbuffer[t]);
        ...
        const J = {[p]: 10497, [f]: 33071, [m]: 33648},
            Q = {[g]: 9728, 1004: 9984, 1005: 9986, [v]: 9729, 1007: 9985, [_]: 9987};
        ...
        function ee(t, i) {
            ...
            if (o !== t.__cacheKey) {
                ...
                void 0 !== r && (a[t.__cacheKey].usedTimes--, 0 === r.usedTimes && X(i)), t.__cacheKey = o, t.__webglTexture = a[o].texture
            }
            return n
        }
        ...
        function te(t, n, r) {
            ...
            if (i.activeTexture(33984 + r), i.bindTexture(s, t.__webglTexture), c.version !== c.__currentVersion || !0 === l) {
                ...
                r = oe(n, r);
                const u = O(r) || o, d = a.convert(n.format, n.encoding);
                let p, m = a.convert(n.type), _ = B(n.internalFormat, d, m, n.encoding, n.isVideoTexture);
                $(s, n, u);
                const x = n.mipmaps, b = o && !0 !== n.isVideoTexture, A = void 0 === c.__currentVersion || !0 === l,
                    C = H(n, r, u);
                if (n.isDepthTexture) _ = 6402, o ? _ = n.type === M ? 36012 : n.type === y ? 33190 : n.type === S ? 35056 : 33189 : n.type === M && console.error("WebGLRenderer: Floating point depth texture requires WebGL2."), n.format === T && 6402 === _ && 1012 !== n.type && n.type !== y && (console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."), n.type = y, m = a.convert(n.type)), n.format === E && 6402 === _ && (_ = 34041, n.type !== S && (console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."), n.type = S, m = a.convert(n.type))), A && (b ? i.texStorage2D(3553, 1, _, r.width, r.height) : i.texImage2D(3553, 0, _, r.width, r.height, 0, d, m, null)); else if (n.isDataTexture) if (x.length > 0 && u) {
                    ...
                    n.generateMipmaps = !1
                } else b ? (A && i.texStorage2D(3553, C, _, r.width, r.height), i.texSubImage2D(3553, 0, 0, 0, r.width, r.height, d, m, r.data)) : i.texImage2D(3553, 0, _, r.width, r.height, 0, d, m, r.data); else if (n.isCompressedTexture) {
                    b && A && i.texStorage2D(3553, C, _, x[0].width, x[0].height);
                ...
                } else if (n.isDataArrayTexture) b ? (A && i.texStorage3D(35866, C, _, r.width, r.height, r.depth), i.texSubImage3D(35866, 0, 0, 0, 0, r.width, r.height, r.depth, d, m, r.data)) : i.texImage3D(35866, 0, _, r.width, r.height, r.depth, 0, d, m, r.data); else if (n.isData3DTexture) b ? (A && i.texStorage3D(32879, C, _, r.width, r.height, r.depth), i.texSubImage3D(32879, 0, 0, 0, 0, r.width, r.height, r.depth, d, m, r.data)) : i.texImage3D(32879, 0, _, r.width, r.height, r.depth, 0, d, m, r.data); else if (n.isFramebufferTexture) {
                    if (A) if (b) i.texStorage2D(3553, C, _, r.width, r.height); else {
                        let e = r.width, t = r.height;
                ...
                U(n, u) && k(s), c.__currentVersion = c.version, n.onUpdate && n.onUpdate(n)
            }
            t.__version = n.version
        }

        function ie(t, r, s, o, l) {
            const c = a.convert(s.format, s.encoding), h = a.convert(s.type), u = B(s.internalFormat, c, h, s.encoding);
        ...
        function ne(t, i, n) {
            if (e.bindRenderbuffer(36161, t), i.depthBuffer && !i.stencilBuffer) {
                ...
                for (let r = 0; r < t.length; r++) {
                    const s = t[r], o = a.convert(s.format, s.encoding), l = a.convert(s.type),
                        c = B(s.internalFormat, o, l, s.encoding), h = ae(i);
        ...
        function re(t) {
            ...
            if (t.depthTexture && !r.__autoAllocateDepthBuffer) {
                ...
                !function (t, r) {
                    ...
                    const a = n.get(r.depthTexture).__webglTexture, s = ae(r);
                    if (r.depthTexture.format === T) se(r) ? d.framebufferTexture2DMultisampleEXT(36160, 36096, 3553, a, 0, s) : e.framebufferTexture2D(36160, 36096, 3553, a, 0); else {
        ...
        function oe(e, i) {
            const n = e.encoding, r = e.format, a = e.type;
            return !0 === e.isCompressedTexture || !0 === e.isVideoTexture || e.format === F || n !== R && (n === D ? !1 === o ? !0 === t.has("EXT_sRGB") && r === w ? (e.format = F, e.minFilter = v, e.generateMipmaps = !1) : i = ce.sRGBToLinear(i) : r === w && a === x || console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture encoding:", n)), i
        }
        ...
        this.allocateTextureUnit = function () {
            ...
            t.version > 0 && s.__version !== t.version ? function (t, n, r) {
                ...
                if (i.activeTexture(33984 + r), i.bindTexture(34067, t.__webglTexture), l.version !== l.__currentVersion || !0 === s) {
                    ...
                    const t = n.isCompressedTexture || n.image[0].isCompressedTexture,
                        r = n.image[0] && n.image[0].isDataTexture, h = [];
                    for (let e = 0; e < 6; e++) h[e] = t || r ? r ? n.image[e].image : n.image[e] : z(n.image[e], !1, !0, c), h[e] = oe(n, h[e]);
                    const u = h[0], d = O(u) || o, p = a.convert(n.format, n.encoding), f = a.convert(n.type),
                        m = B(n.internalFormat, p, f, n.encoding), g = o && !0 !== n.isVideoTexture,
                    ...
                    U(n, d) && k(34067), l.__currentVersion = l.version, n.onUpdate && n.onUpdate(n)
                }
                t.__version = n.version
            ...
            const u = !0 === t.isWebGLCubeRenderTarget, d = !0 === t.isWebGLMultipleRenderTargets, p = O(t) || o;
            if (u) {
                c.__webglFramebuffer = [];
                for (let t = 0; t < 6; t++) c.__webglFramebuffer[t] = e.createFramebuffer()
            } else {
                if (c.__webglFramebuffer = e.createFramebuffer(), d) if (r.drawBuffers) {
                    const i = t.texture;
                ...
                if (o && t.samples > 0 && !1 === se(t)) {
                    ...
                    for (let i = 0; i < n.length; i++) {
                        ...
                        const s = a.convert(r.format, r.encoding), o = a.convert(r.type),
                            l = B(r.internalFormat, s, o, r.encoding), h = ae(t);
            ...
            if (u) {
                ...
                for (let r = 0, a = e.length; r < a; r++) {
                    ...
                    i.bindTexture(3553, s.__webglTexture), $(3553, a, p), ie(c.__webglFramebuffer, t, a, 36064 + r, 3553), U(a, p) && k(3553)
                }
                i.unbindTexture()
            } else {
                let e = 3553;
                (t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) && (o ? e = t.isWebGL3DRenderTarget ? 32879 : 35866 : console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")), i.bindTexture(e, h.__webglTexture), $(e, l, p), ie(c.__webglFramebuffer, t, l, 36064, e), U(l, p) && k(e), i.unbindTexture()
            }
            t.depthBuffer && re(t)
        }, this.updateRenderTargetMipmap = function (e) {
            const t = O(e) || o, r = !0 === e.isWebGLMultipleRenderTargets ? e.texture : [e.texture];
            for (let a = 0, s = r.length; a < s; a++) {
                const s = r[a];
                if (U(s, t)) {
                    const t = e.isWebGLCubeRenderTarget ? 34067 : 3553, r = n.get(s).__webglTexture;
                    i.bindTexture(t, r), k(t), i.unbindTexture()
                }
            }
        }, this.updateMultisampleRenderTarget = function (t) {
            if (o && t.samples > 0 && !1 === se(t)) {
                const r = t.isWebGLMultipleRenderTargets ? t.texture : [t.texture], a = t.width, s = t.height;
                let o = 16384;
                const l = [], c = t.stencilBuffer ? 33306 : 36096, h = n.get(t),
                    u = !0 === t.isWebGLMultipleRenderTargets;
                if (u) for (let t = 0; t < r.length; t++) i.bindFramebuffer(36160, h.__webglMultisampledFramebuffer), e.framebufferRenderbuffer(36160, 36064 + t, 36161, null), i.bindFramebuffer(36160, h.__webglFramebuffer), e.framebufferTexture2D(36009, 36064 + t, 3553, null, 0);
                ...
                if (i.bindFramebuffer(36008, null), i.bindFramebuffer(36009, null), u) for (let t = 0; t < r.length; t++) {
    ...
    class ca {
        ...
        getHandSpace() {
            return null === this._hand && (this._hand = new oa, this._hand.matrixAutoUpdate = !1, this._hand.visible = !1, this._hand.joints = {}, this._hand.inputState = {pinching: !1}), this._hand
        }

        getTargetRaySpace() {
            return null === this._targetRay && (this._targetRay = new oa, this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new xe, this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new xe), this._targetRay
        }

        getGripSpace() {
            return null === this._grip && (this._grip = new oa, this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new xe, this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new xe), this._grip
        }
        ...
        update(e, t, i) {
            ...
            if (e && "visible-blurred" !== t.session.visibilityState) {
                ...
                null !== s && (n = t.getPose(e.targetRaySpace, i), null === n && null !== r && (n = r), null !== n && (s.matrix.fromArray(n.transform.matrix), s.matrix.decompose(s.position, s.rotation, s.scale), n.linearVelocity ? (s.hasLinearVelocity = !0, s.linearVelocity.copy(n.linearVelocity)) : s.hasLinearVelocity = !1, n.angularVelocity ? (s.hasAngularVelocity = !0, s.angularVelocity.copy(n.angularVelocity)) : s.hasAngularVelocity = !1, this.dispatchEvent(la)))
            }
    ...
    class ua extends U {
        constructor(e, t) {
            super();
            const i = this;
            let n = null, r = 1, a = null, s = "local-floor", o = null, l = null, c = null, h = null, u = null,
                d = null;
            const p = t.getContextAttributes();
            let f = null, m = null;
            const g = [], v = [], _ = new Mi;
            _.layers.enable(1), _.viewport = new fe;
            const M = new Mi;
            M.layers.enable(2), M.viewport = new fe;
            const b = [_, M], A = new sa;
            ...
            function R() {
                ...
                C = null, L = null, e.setRenderTarget(f), u = null, h = null, c = null, n = null, m = null, F.stop(), i.isPresenting = !1, i.dispatchEvent({type: "sessionend"})
            }

            function D(e) {
                for (let t = 0; t < e.removed.length; t++) {
                    const i = e.removed[t], n = v.indexOf(i);
            ...
            this.cameraAutoUpdate = !0, this.enabled = !1, this.isPresenting = !1, this.getController = function (e) {
                let t = g[e];
                return void 0 === t && (t = new ca, g[e] = t), t.getTargetRaySpace()
            }, this.getControllerGrip = function (e) {
                let t = g[e];
                return void 0 === t && (t = new ca, g[e] = t), t.getGripSpace()
            }, this.getHand = function (e) {
                let t = g[e];
                return void 0 === t && (t = new ca, g[e] = t), t.getHandSpace()
                ...
                if (n = l, null !== n) {
                    if (f = e.getRenderTarget(), n.addEventListener("select", P), n.addEventListener("selectstart", P), n.addEventListener("selectend", P), n.addEventListener("squeeze", P), n.addEventListener("squeezestart", P), n.addEventListener("squeezeend", P), n.addEventListener("end", R), n.addEventListener("inputsourceschange", D), !0 !== p.xrCompatible && await t.makeXRCompatible(), void 0 === n.renderState.layers || !1 === e.capabilities.isWebGL2) {
                        ...
                        u = new XRWebGLLayer(n, t, i), n.updateRenderState({baseLayer: u}), m = new me(u.framebufferWidth, u.framebufferHeight, {
                            format: w,
                            type: x,
                        ...
                        c = new XRWebGLBinding(n, t), h = c.createProjectionLayer(o), n.updateRenderState({layers: [h]}), m = new me(h.textureWidth, h.textureHeight, {
                            format: w,
                            type: x,
                            depthTexture: new ha(h.textureWidth, h.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, i),
                    ...
                    m.isXRRenderTarget = !0, this.setFoveation(1), o = null, a = await n.requestReferenceSpace(s), F.setContext(n), F.start(), i.isPresenting = !0, i.dispatchEvent({type: "sessionstart"})
                }
            };
            const I = new xe, N = new xe;
            ...
            this.updateCamera = function (e) {
                ...
                2 === i.length ? function (e, t, i) {
                    ...
                    const n = I.distanceTo(N), r = t.projectionMatrix.elements, a = i.projectionMatrix.elements,
                        s = r[14] / (r[10] - 1), o = r[14] / (r[10] + 1), l = (r[9] + 1) / r[5], c = (r[9] - 1) / r[5],
                        h = (r[8] - 1) / r[0], u = (a[8] + 1) / a[0], d = s * h, p = s * u, f = n / (-h + u),
                        m = f * -h;
                    ...
                    const g = s + f, v = o + f, _ = d - m, x = p + (n - m), y = l * o / v * g, M = c * o / v * g;
            ...
            F.setAnimationLoop((function (t, i) {
                if (l = i.getViewerPose(o || a), d = i, null !== l) {
                    ...
                    for (let n = 0; n < t.length; n++) {
                        ...
                        let s = b[n];
                        void 0 === s && (s = new Mi, s.layers.enable(n), s.viewport = new fe, b[n] = s), s.matrix.fromArray(r.transform.matrix), s.projectionMatrix.fromArray(r.projectionMatrix), s.viewport.set(a.x, a.y, a.width, a.height), 0 === n && A.matrix.copy(s.matrix), !0 === i && A.cameras.push(s)
                    }
                }
                for (let e = 0; e < g.length; e++) {
                    const t = v[e], n = g[e];
    ...
    function pa(e = {}) {
        ...
        const t = void 0 !== e.canvas ? e.canvas : function () {
            ...
            }(), i = void 0 !== e.context ? e.context : null, n = void 0 === e.depth || e.depth,
            r = void 0 === e.stencil || e.stencil, a = void 0 !== e.antialias && e.antialias,
        ...
        const m = this;
        let g = !1, v = 0, y = 0, S = null, T = -1, E = null;
        const A = new fe, C = new fe;
        let L = null, P = t.width, D = t.height, I = 1, N = null, z = null;
        const O = new fe(0, 0, P, D), F = new fe(0, 0, P, D);
        let U = !1;
        const k = new Di;
        let B = !1, H = !1, G = null;
        const V = new Ke, W = new X, j = new xe,
        ...
        let J, Q, $, ee, te, ie, ne, re, ae, se, oe, le, ce, he, ue, de, pe, ge, ve, _e, ye, Me, be, Se = i;
        ...
        function Te() {
            J = new ln(Se), Q = new Gi(Se, J, e), J.init(Q), Me = new aa(Se, J, Q), $ = new na(Se, J, Q), ee = new un, te = new Vr, ie = new ra(Se, J, $, te, Q, Me, ee), ne = new Wi(m), re = new on(m), ae = new Ni(Se, Q), be = new Bi(Se, J, ae, Q), se = new cn(Se, ae, ee, be), oe = new gn(Se, se, ae, ee), ve = new mn(Se, Q, ie), de = new Vi(te), le = new Gr(m, ne, re, J, Q, be, de), ce = new da(m, te), he = new Xr, ue = new $r(J, Q), ge = new ki(m, ne, $, oe, h, s), pe = new ia(m, oe, Q), _e = new Hi(Se, J, ee, Q), ye = new hn(Se, J, ee, Q), ee.programs = le.programs, m.capabilities = Q, m.extensions = J, m.properties = te, m.renderLists = he, m.shadowMap = pe, m.state = $, m.info = ee
        }

        Te();
        const Ee = new ua(m, Se);
        ...
        function Ce() {
            ...
            const e = ee.autoReset, t = pe.enabled, i = pe.autoUpdate, n = pe.needsUpdate, r = pe.type;
        ...
        function Pe(e) {
            const t = e.target;
            t.removeEventListener("dispose", Pe), function (e) {
                (function (e) {
        ...
        this.xr = Ee, this.getContext = function () {
            ...
            Ee.isPresenting ? console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.") : (P = e, D = i, t.width = Math.floor(e * I), t.height = Math.floor(i * I), !1 !== n && (t.style.width = e + "px", t.style.height = i + "px"), this.setViewport(0, 0, e, i))
            ...
            e.isVector4 ? F.set(e.x, e.y, e.z, e.w) : F.set(e, t, i, n), $.scissor(C.copy(F).multiplyScalar(I).floor())
            ...
            const s = r.isMesh && r.matrixWorld.determinant() < 0, o = function (e, t, i, n, r) {
                ...
                const a = t.fog, s = n.isMeshStandardMaterial ? t.environment : null,
                    ...
                    p = !!i.morphAttributes.normal, f = !!i.morphAttributes.color, g = n.toneMapped ? m.toneMapping : 0,
                    v = i.morphAttributes.position || i.morphAttributes.normal || i.morphAttributes.color,
                    _ = void 0 !== v ? v.length : 0, x = te.get(n), y = d.state.lights;
                if (!0 === B && (!0 === H || e !== E)) {
                    const t = e === E && n.id === T;
                    de.setState(n, e, t)
                }
                ...
                !0 === M && (b = ke(n, t, r));
                let w = !1, A = !1, C = !1;
                const L = b.getUniforms(), P = x.uniforms;
            ...
            let p = _e;
            null !== l && (h = ae.get(l), p = ye, p.setIndex(h));
            const f = null !== l ? l.count : c.count, g = i.drawRange.start * u, v = i.drawRange.count * u,
                _ = null !== a ? a.start * u : 0, x = null !== a ? a.count * u : 1 / 0, y = Math.max(g, _),
                M = Math.min(f, g + v, _ + x) - 1, b = Math.max(0, M - y + 1);
            if (0 !== b) {
                if (r.isMesh) !0 === n.wireframe ? ($.setLineWidth(n.wireframeLinewidth * Z()), p.setMode(1)) : p.setMode(4); else if (r.isLine) {
                    let e = n.linewidth;
        ...
        function ze(e, t, i, n) {
            ...
            if (e.layers.test(t.layers)) if (e.isGroup) i = e.renderOrder; else if (e.isLOD) !0 === e.autoUpdate && e.update(t); else if (e.isLight) d.pushLight(e), e.castShadow && d.pushShadow(e); else if (e.isSprite) {
                if (!e.frustumCulled || k.intersectsSprite(e)) {
                    n && j.setFromMatrixPosition(e.matrixWorld).applyMatrix4(V);
                    const t = oe.update(e), r = e.material;
                    r.visible && u.push(e, t, r, i, j.z, null)
                }
            } else if ((e.isMesh || e.isLine || e.isPoints) && (e.isSkinnedMesh && e.skeleton.frame !== ee.render.frame && (e.skeleton.update(), e.skeleton.frame = ee.render.frame), !e.frustumCulled || k.intersectsObject(e))) {
                n && j.setFromMatrixPosition(e.matrixWorld).applyMatrix4(V);
                const t = oe.update(e), r = e.material;
                if (Array.isArray(r)) {
                    const n = t.groups;
        ...
        function Oe(e, t, i, n) {
            ...
            d.setupLightsView(i), s.length > 0 && function (e, t, i) {
                ...
                m.getDrawingBufferSize(W), n ? G.setSize(W.x, W.y) : G.setSize(q(W.x), q(W.y));
                const r = m.getRenderTarget();
                m.setRenderTarget(G), m.clear();
                const s = m.toneMapping;
                m.toneMapping = 0, Fe(e, t, i), m.toneMapping = s, ie.updateMultisampleRenderTarget(G), ie.updateRenderTargetMipmap(G), m.setRenderTarget(r)
            }(r, t, i), n && $.viewport(A.copy(n)), r.length > 0 && Fe(r, t, i), s.length > 0 && Fe(s, t, i), o.length > 0 && Fe(o, t, i), $.buffers.depth.setTest(!0), $.buffers.depth.setMask(!0), $.buffers.color.setMask(!0), $.setPolygonOffset(!1)
        }
        ...
        function Fe(e, t, i) {
            ...
            for (let r = 0, a = e.length; r < a; r++) {
                ...
                s.layers.test(i.layers) && Ue(s, t, i, o, l, c)
            }
        }
        ...
        function ke(e, t, i) {
            !0 !== t.isScene && (t = Y);
            const n = te.get(e), r = d.state.lights, a = d.state.shadowsArray, s = r.state.version,
                o = le.getParameters(e, r.state, a, t, i), l = le.getProgramCacheKey(o);
            let c = n.programs;
            ...
            let h = c.get(l);
            if (void 0 !== h) {
                if (n.currentProgram === h && n.lightsStateVersion === s) return Be(e, o), h
            ...
            const u = n.uniforms;
            (e.isShaderMaterial || e.isRawShaderMaterial) && !0 !== e.clipping || (u.clippingPlanes = de.uniform), Be(e, o), n.needsLights = function (e) {
            ...
            const p = h.getUniforms(), f = yr.seqWithValue(p.seq, u);
        ...
        Ne.setAnimationLoop((function (e) {
            ...
            } else A.copy(O).multiplyScalar(I).floor(), C.copy(F).multiplyScalar(I).floor(), L = U;
            if ($.bindFramebuffer(36160, r) && Q.drawBuffers && n && $.drawBuffers(e, r), $.viewport(A), $.scissor(C), $.setScissorTest(L), a) {
                ...
                const n = te.get(e.texture), r = t || 0;
            ...
            const r = t.image.width, a = t.image.height, s = Me.convert(i.format), o = Me.convert(i.type);
            ...
            const a = e.max.x - e.min.x + 1, s = e.max.y - e.min.y + 1, o = e.max.z - e.min.z + 1,
                l = Me.convert(n.format), c = Me.convert(n.type);
            let h;
            if (n.isData3DTexture) ie.setTexture3D(n, 0), h = 32879; else {
            ...
            const u = Se.getParameter(3314), d = Se.getParameter(32878), p = Se.getParameter(3316),
                f = Se.getParameter(3315), g = Se.getParameter(32877),
    ...
    class fa extends Mt {
        constructor() {
            super(), this.isScene = !0, this.type = "Scene", this.background = null, this.environment = null, this.fog = null, this.overrideMaterial = null, this.autoUpdate = !0, "undefined" != typeof __THREE_DEVTOOLS__ && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", {detail: this}))
        }
    ...
    const va = new Ke, _a = new xe, xa = new xe;
    const ya = new Ke, Ma = new xe, ba = new xe;

    class Sa extends class {
        constructor(e) {
            this.camera = e, this.bias = 0, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new X(512, 512), this.map = null, this.mapPass = null, this.matrix = new Ke, this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new Di, this._frameExtents = new X(1, 1), this._viewportCount = 1, this._viewports = [new fe(0, 0, 1, 1)]
        }
        ...
        updateMatrices(e) {
            ...
            _a.setFromMatrixPosition(e.matrixWorld), t.position.copy(_a), xa.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(xa), t.updateMatrixWorld(), va.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(va), i.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), i.multiply(t.projectionMatrix), i.multiply(t.matrixWorldInverse)
        }
        ...
        constructor() {
            super(new Mi(90, 1, .5, 500)), this.isPointLightShadow = !0, this._frameExtents = new X(4, 2), this._viewportCount = 6, this._viewports = [new fe(2, 1, 1, 1), new fe(0, 1, 1, 1), new fe(3, 1, 1, 1), new fe(1, 1, 1, 1), new fe(3, 0, 1, 1), new fe(1, 0, 1, 1)], this._cubeDirections = [new xe(1, 0, 0), new xe(-1, 0, 0), new xe(0, 0, 1), new xe(0, 0, -1), new xe(0, 1, 0), new xe(0, -1, 0)], this._cubeUps = [new xe(0, 1, 0), new xe(0, 1, 0), new xe(0, 1, 0), new xe(0, 1, 0), new xe(0, 0, 1), new xe(0, 0, -1)]
        }

        updateMatrices(e, t = 0) {
            const i = this.camera, n = this.matrix, r = e.distance || i.far;
            r !== i.far && (i.far = r, i.updateProjectionMatrix()), Ma.setFromMatrixPosition(e.matrixWorld), i.position.copy(Ma), ba.copy(i.position), ba.add(this._cubeDirections[t]), i.up.copy(this._cubeUps[t]), i.lookAt(ba), i.updateMatrixWorld(), n.makeTranslation(-Ma.x, -Ma.y, -Ma.z), ya.multiplyMatrices(i.projectionMatrix, i.matrixWorldInverse), this._frustum.setFromProjectionMatrix(ya)
        }
    }

    class wa extends ga {
        constructor(e, t, i = 0, n = 1) {
            super(e, t), this.isPointLight = !0, this.type = "PointLight", this.distance = i, this.decay = n, this.shadow = new Sa
        }
    ...
    class Ea {
        ...
        start() {
            this.startTime = Aa(), this.oldTime = this.startTime, this.elapsedTime = 0, this.running = !0
        }
    ...
    class Ca {
        ...
        setFromCartesianCoords(e, t, i) {
            return this.radius = Math.sqrt(e * e + t * t + i * i), 0 === this.radius ? (this.theta = 0, this.phi = 0) : (this.theta = Math.atan2(e, i), this.phi = Math.acos(V(t / this.radius, -1, 1))), this
        }
    ...
    function La(e, t, i, n, r, a, s, o) {
        const l = (e, t, i, n) => [new X(e / s, 1 - n / o), new X(i / s, 1 - n / o), new X(i / s, 1 - t / o), new X(e / s, 1 - t / o)],
            c = l(t + a, i, t + n + a, i + a), h = l(t + n + a, i, t + 2 * n + a, i + a),
            u = l(t, i + a, t + a, i + a + r), d = l(t + a, i + a, t + n + a, i + a + r),
    ...
    function Pa(e, t, i, n, r, a) {
        La(e, t, i, n, r, a, 64, 64)
    }

    function Ra(e, t, i, n, r, a) {
        La(e, t, i, n, r, a, 64, 32)
    }
    ...
    class Ia extends oa {
        constructor(e) {
            ...
            const t = new ma({map: e, side: 0}), i = new ma({map: e, side: 2, transparent: !0, alphaTest: 1e-5}),
                n = t.clone();
            ...
            const a = new mi(8, 8, 8);
            Pa(a, 0, 0, 8, 8, 8);
            const s = new pi(a, t), o = new mi(9, 9, 9);
            Pa(o, 32, 0, 8, 8, 8);
            const l = new pi(o, i);
            this.head = new Da(s, l), this.head.name = "head", this.head.add(s, l), s.position.y = 4, l.position.y = 4, this.add(this.head);
            const c = new mi(8, 12, 4);
            Pa(c, 16, 16, 8, 12, 4);
            const h = new pi(c, t), u = new mi(8.5, 12.5, 4.5);
            Pa(u, 16, 32, 8, 12, 4);
            const d = new pi(u, i);
            this.body = new Da(h, d), this.body.name = "body", this.body.add(h, d), this.body.position.y = -6, this.add(this.body);
            const p = new mi, f = new pi(p, n);
            this.modelListeners.push((() => {
                f.scale.x = this.slim ? 3 : 4, f.scale.y = 12, f.scale.z = 4, Pa(p, 40, 16, this.slim ? 3 : 4, 12, 4)
            }));
            const m = new mi, g = new pi(m, r);
            this.modelListeners.push((() => {
                g.scale.x = this.slim ? 3.5 : 4.5, g.scale.y = 12.5, g.scale.z = 4.5, Pa(m, 40, 32, this.slim ? 3 : 4, 12, 4)
            }));
            const v = new oa;
            v.add(f, g), this.modelListeners.push((() => {
                v.position.x = this.slim ? -.5 : -1
            })), v.position.y = -4, this.rightArm = new Da(f, g), this.rightArm.name = "rightArm", this.rightArm.add(v), this.rightArm.position.x = -5, this.rightArm.position.y = -2, this.add(this.rightArm);
            const _ = new mi, x = new pi(_, n);
            this.modelListeners.push((() => {
                x.scale.x = this.slim ? 3 : 4, x.scale.y = 12, x.scale.z = 4, Pa(_, 32, 48, this.slim ? 3 : 4, 12, 4)
            }));
            const y = new mi, M = new pi(y, r);
            this.modelListeners.push((() => {
                M.scale.x = this.slim ? 3.5 : 4.5, M.scale.y = 12.5, M.scale.z = 4.5, Pa(y, 48, 48, this.slim ? 3 : 4, 12, 4)
            }));
            const b = new oa;
            b.add(x, M), this.modelListeners.push((() => {
                b.position.x = this.slim ? .5 : 1
            })), b.position.y = -4, this.leftArm = new Da(x, M), this.leftArm.name = "leftArm", this.leftArm.add(b), this.leftArm.position.x = 5, this.leftArm.position.y = -2, this.add(this.leftArm);
            const S = new mi(4, 12, 4);
            Pa(S, 0, 16, 4, 12, 4);
            const w = new pi(S, n), T = new mi(4.5, 12.5, 4.5);
            Pa(T, 0, 32, 4, 12, 4);
            const E = new pi(T, r), A = new oa;
            A.add(w, E), A.position.y = -6, this.rightLeg = new Da(w, E), this.rightLeg.name = "rightLeg", this.rightLeg.add(A), this.rightLeg.position.x = -1.9, this.rightLeg.position.y = -12, this.rightLeg.position.z = -.1, this.add(this.rightLeg);
            const C = new mi(4, 12, 4);
            Pa(C, 16, 48, 4, 12, 4);
            const L = new pi(C, n), P = new mi(4.5, 12.5, 4.5);
            Pa(P, 0, 48, 4, 12, 4);
            const R = new pi(P, r), D = new oa;
            D.add(L, R), D.position.y = -6, this.leftLeg = new Da(L, R), this.leftLeg.name = "leftLeg", this.leftLeg.add(D), this.leftLeg.position.x = 1.9, this.leftLeg.position.y = -12, this.leftLeg.position.z = -.1, this.add(this.leftLeg), this.modelType = "default"
        }
    ...
    class Na extends oa {
        constructor(e) {
            super();
            const t = new ma({map: e, side: 2, transparent: !0, alphaTest: 1e-5}), i = new mi(10, 16, 1);
            Ra(i, 0, 0, 10, 16, 1), this.cape = new pi(i, t), this.cape.position.y = -8, this.cape.position.z = .5, this.add(this.cape)
        }
    }
    ...
    class za extends oa {
        constructor(e) {
            super();
            const t = new ma({map: e, side: 2, transparent: !0, alphaTest: 1e-5}), i = new mi(12, 22, 4);
            Ra(i, 22, 0, 10, 20, 2);
            const n = new pi(i, t);
            n.position.x = -5, n.position.y = -10, n.position.z = -1, this.leftWing = new oa, this.leftWing.add(n), this.add(this.leftWing);
            const r = new mi(12, 22, 4);
            Ra(r, 22, 0, 10, 20, 2);
            const a = new pi(r, t);
            a.scale.x = -1, a.position.x = 5, a.position.y = -10, a.position.z = -1, this.rightWing = new oa, this.rightWing.add(a), this.add(this.rightWing), this.leftWing.position.x = 5, this.leftWing.rotation.x = .2617994, this.leftWing.rotation.y = .01, this.leftWing.rotation.z = .2617994, this.updateRightWing()
        }
    ...
    class Oa extends oa {
        constructor(e) {
            super();
            const t = new ma({map: e, side: 0}), i = new mi(8, 8, 4 / 3);
            La(i, 0, 0, 6, 6, 1, 14, 7), this.rightEar = new pi(i, t), this.rightEar.name = "rightEar", this.rightEar.position.x = -6, this.add(this.rightEar), this.leftEar = new pi(i, t), this.leftEar.name = "leftEar", this.leftEar.position.x = 6, this.add(this.leftEar)
        }
    }

    class Fa extends oa {
        constructor(e, t, i) {
            super(), this.skin = new Ia(e), this.skin.name = "skin", this.skin.position.y = 8, this.add(this.skin), this.cape = new Na(t), this.cape.name = "cape", this.cape.position.y = 8, this.cape.position.z = -2, this.cape.rotation.x = 10.8 * Math.PI / 180, this.cape.rotation.y = Math.PI, this.add(this.cape), this.elytra = new za(t), this.elytra.name = "elytra", this.elytra.position.y = 8, this.elytra.position.z = -2, this.elytra.visible = !1, this.add(this.elytra), this.ears = new Oa(i), this.ears.name = "ears", this.ears.position.y = 10, this.ears.position.z = 2 / 3, this.ears.visible = !1, this.skin.head.add(this.ears)
        }
    ...
    function Ha(e, t, i) {
        ...
        const n = Ba(t), r = (t, i, r, a) => e.clearRect(t * n, i * n, r * n, a * n);
    ...
    function Ga(e, t) {
        ...
        if (i) {
            ...
            e.width = i, e.height = i, n.clearRect(0, 0, i, i), n.drawImage(t, 0, 0, i, i / 2), function (e, t) {
                const i = Ba(t), n = (t, n, r, a, s, o, l) => function (e, t, i, n, r, a, s, o) {
                    ...
                    if (o) for (let e = 0; e < r; e++) for (let t = 0; t < n / 2; t++) {
                        const i = 4 * (t + e * n), r = 4 * (n - t - 1 + e * n), a = l.data[i], s = l.data[i + 1],
                            o = l.data[i + 2], c = l.data[i + 3], h = l.data[r], u = l.data[r + 1], d = l.data[r + 2],
                            p = l.data[r + 3];
    ...
    function ja(e, t) {
        ...
        const i = Ba(t.width), n = 14 * i, r = 7 * i;
    ...
    const Za = new ji(-1, 1, 1, -1, 0, 1), Ka = new Zt;
    Ka.setAttribute("position", new Ht([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)), Ka.setAttribute("uv", new Ht([0, 2, 0, 0, 2, 0], 2));

    class Ja {
        constructor(e) {
            this._mesh = new pi(Ka, e)
        }
    ...
    class Qa extends Ya {
        constructor(e, t) {
            super(), this.textureID = void 0 !== t ? t : "tDiffuse", e instanceof xi ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = _i.clone(e.uniforms), this.material = new xi({
    ...
    class ts {
        constructor(e, t) {
            if (this.renderer = e, void 0 === t) {
                ...
                this._pixelRatio = e.getPixelRatio(), this._width = i.width, this._height = i.height, (t = new me(this._width * this._pixelRatio, this._height * this._pixelRatio)).texture.name = "EffectComposer.rt1"
            } else this._pixelRatio = 1, this._width = t.width, this._height = t.height;
            this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = !0, this.passes = [], void 0 === Xa && console.error("THREE.EffectComposer relies on CopyShader"), void 0 === Qa && console.error("THREE.EffectComposer relies on ShaderPass"), this.copyPass = new Qa(Xa), this.clock = new Ea
        }
        ...
        render(e) {
            ...
            for (let t = 0, n = this.passes.length; t < n; t++) {
                ...
                if (!1 !== n.enabled) {
                    ...
                    void 0 !== $a && (n instanceof $a ? i = !0 : n instanceof es && (i = !1))
                }
            }
    ...
    new ji(-1, 1, 1, -1, 0, 1);
    const is = new Zt;
    is.setAttribute("position", new Ht([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)), is.setAttribute("uv", new Ht([0, 2, 0, 0, 2, 0], 2));

    class ns extends Ya {
        constructor(e, t, i, n, r) {
            super(), this.scene = e, this.camera = t, this.overrideMaterial = i, this.clearColor = n, this.clearAlpha = void 0 !== r ? r : 0, this.clear = !0, this.clearDepth = !1, this.needsSwap = !1, this._oldClearColor = new oe
        }
    ...
    class ss {
        ...
        play(e, t) {
            if (this.toResetAndRemove) return as(this.animation, e, 0), void this.remove();
            let i;
            this.started ? i = t - this.lastTime : (i = 0, this.started = !0), this.lastTime = t, this.paused || (this.progress += i * this.speed), as(this.animation, e, this.progress)
        }
    ...
    const cs = {type: "change"}, hs = {type: "start"}, us = {type: "end"};
    ...
    class ds extends U {
        constructor(e, l) {
            super(), void 0 === l && console.warn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.'), l === document && console.error('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.'), this.object = e, this.domElement = l, this.domElement.style.touchAction = "none", this.enabled = !0, this.target = new xe, this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = {
                ...
                c.target.copy(c.target0), c.object.position.copy(c.position0), c.object.zoom = c.zoom0, c.object.updateProjectionMatrix(), c.dispatchEvent(cs), c.update(), u = h.NONE
            }, this.update = function () {
                const t = new xe, i = (new _e).setFromUnitVectors(e.up, new xe(0, 1, 0)), n = i.clone().invert(),
                    r = new xe, a = new _e, s = 2 * Math.PI;
                return function () {
            ...
            let u = h.NONE;
            const d = 1e-6, p = new Ca, f = new Ca;
            let m = 1;
            const g = new xe;
            let v = !1;
            const _ = new X, x = new X, y = new X, M = new X, b = new X, S = new X, w = new X, T = new X, E = new X,
                A = [], C = {};
            ...
            function k() {
                if (1 === A.length) _.set(A[0].pageX, A[0].pageY); else {
                    const e = .5 * (A[0].pageX + A[1].pageX), t = .5 * (A[0].pageY + A[1].pageY);
                    _.set(e, t)
                }
            }

            function B() {
                if (1 === A.length) M.set(A[0].pageX, A[0].pageY); else {
                    const e = .5 * (A[0].pageX + A[1].pageX), t = .5 * (A[0].pageY + A[1].pageY);
                    M.set(e, t)
                }
            }
            ...
            function H() {
                const e = A[0].pageX - A[1].pageX, t = A[0].pageY - A[1].pageY, i = Math.sqrt(e * e + t * t);
                w.set(0, i)
            }

            function G(e) {
                if (1 == A.length) x.set(e.pageX, e.pageY); else {
                    const t = te(e), i = .5 * (e.pageX + t.x), n = .5 * (e.pageY + t.y);
                    x.set(i, n)
                }
            ...
            function V(e) {
                if (1 === A.length) b.set(e.pageX, e.pageY); else {
                    const t = te(e), i = .5 * (e.pageX + t.x), n = .5 * (e.pageY + t.y);
                    b.set(i, n)
                }
            ...
            function W(e) {
                const t = te(e), i = e.pageX - t.x, n = e.pageY - t.y, r = Math.sqrt(i * i + n * n);
                T.set(0, r), E.set(0, Math.pow(T.y / w.y, c.zoomSpeed)), z(E.y), w.copy(T)
            }

            function j(e) {
                !1 !== c.enabled && (0 === A.length && (c.domElement.setPointerCapture(e.pointerId), c.domElement.addEventListener("pointermove", q), c.domElement.addEventListener("pointerup", Y)), function (e) {
                    A.push(e)
                        ...
                        case 2:
                            switch (c.touches.TWO) {
                                case s:
                                    ...
                                    c.enableZoom && H(), c.enablePan && B(), u = h.TOUCH_DOLLY_PAN;
                                    break;
                                case o:
                                    if (!1 === c.enableZoom && !1 === c.enableRotate) return;
                                    c.enableZoom && H(), c.enableRotate && k(), u = h.TOUCH_DOLLY_ROTATE;
                                    break;
                                default:
                                    u = h.NONE
                            }
            ...
            function Y(e) {
                $(e), 0 === A.length && (c.domElement.releasePointerCapture(e.pointerId), c.domElement.removeEventListener("pointermove", q), c.domElement.removeEventListener("pointerup", Y)), c.dispatchEvent(us), u = h.NONE
            }
            ...
            function K(e) {
                !1 !== c.enabled && !1 !== c.enableZoom && u === h.NONE && (e.preventDefault(), c.dispatchEvent(hs), function (e) {
                    e.deltaY < 0 ? O(L()) : e.deltaY > 0 && z(L()), c.update()
                }(e), c.dispatchEvent(us))
            }
            ...
            function $(e) {
                ...
                for (let t = 0; t < A.length; t++) if (A[t].pointerId == e.pointerId) return void A.splice(t, 1)
            }

            function ee(e) {
                let t = C[e.pointerId];
                void 0 === t && (t = new X, C[e.pointerId] = t), t.set(e.pageX, e.pageY)
            }
            ...
            c.domElement.addEventListener("contextmenu", Q), c.domElement.addEventListener("pointerdown", j), c.domElement.addEventListener("pointercancel", Z), c.domElement.addEventListener("wheel", K, {passive: !1}), this.update()
        }
    }

    e.BodyPart = Da, e.CapeObject = Na, e.CompositeAnimation = os, e.EarsObject = Oa, e.ElytraObject = za, e.FlyingAnimation = (e, t) => {
        t < 0 && (t = 0);
    ...
    }, e.PlayerObject = Fa, e.RootAnimation = ls, e.RotatingAnimation = (e, t) => {
        e.rotation.y = t
    ...
    }, e.SkinObject = Ia, e.SkinViewer = class {
        constructor(e = {}) {
            this.animations = new ls, this.globalLight = new Ta(16777215, .4), this.cameraLight = new wa(16777215, .6), this.backgroundTexture = null, this._disposed = !1, this._renderPaused = !1, this.canvas = void 0 === e.canvas ? document.createElement("canvas") : e.canvas, this.skinCanvas = document.createElement("canvas"), this.skinTexture = new pe(this.skinCanvas), this.skinTexture.magFilter = g, this.skinTexture.minFilter = g, this.capeCanvas = document.createElement("canvas"), this.capeTexture = new pe(this.capeCanvas), this.capeTexture.magFilter = g, this.capeTexture.minFilter = g, this.earsCanvas = document.createElement("canvas"), this.earsTexture = new pe(this.earsCanvas), this.earsTexture.magFilter = g, this.earsTexture.minFilter = g, this.scene = new fa, this.camera = new Mi, this.camera.add(this.cameraLight), this.scene.add(this.camera), this.scene.add(this.globalLight), this.renderer = new pa({
                canvas: this.canvas,
                alpha: !1 !== e.alpha,
                preserveDrawingBuffer: !0 === e.preserveDrawingBuffer
            }), this.renderer.setPixelRatio(window.devicePixelRatio), this.composer = new ts(this.renderer), this.renderPass = new ns(this.scene, this.camera), this.fxaaPass = new Qa(rs), this.composer.addPass(this.renderPass), this.composer.addPass(this.fxaaPass), this.playerObject = new Fa(this.skinTexture, this.capeTexture, this.earsTexture), this.playerObject.name = "player", this.playerObject.skin.visible = !1, this.playerObject.cape.visible = !1, this.playerWrapper = new oa, this.playerWrapper.add(this.playerObject), this.scene.add(this.playerWrapper), void 0 !== e.skin && this.loadSkin(e.skin, {
                model: e.model,
            ...
            }, this.canvas.addEventListener("webglcontextlost", this.onContextLost, !1), this.canvas.addEventListener("webglcontextrestored", this.onContextRestored, !1), this.updateComposerSize()
        }
        ...
        loadSkin(e, t = {}) {
            if (null === e) this.resetSkin(); else {
                if (!Ua(e)) return qa(e).then((e => this.loadSkin(e, t)));
                Ga(this.skinCanvas, e), this.skinTexture.needsUpdate = !0, void 0 === t.model || "auto-detect" === t.model ? this.playerObject.skin.modelType = function (e) {
                    const t = Ba(e.width), i = e.getContext("2d"),
                ...
                }(this.skinCanvas) : this.playerObject.skin.modelType = t.model, !1 !== t.makeVisible && (this.playerObject.skin.visible = !0), !0 !== t.ears && "load-only" != t.ears || (ja(this.earsCanvas, e), this.earsTexture.needsUpdate = !0, !0 === t.ears && (this.playerObject.ears.visible = !0))
            }
        }
        ...
        loadCape(e, t = {}) {
            if (null === e) this.resetCape(); else {
                if (!Ua(e)) return qa(e).then((e => this.loadCape(e, t)));
                Va(this.capeCanvas, e), this.capeTexture.needsUpdate = !0, !1 !== t.makeVisible && (this.playerObject.backEquipment = void 0 === t.backEquipment ? "cape" : t.backEquipment)
            }
        }
        ...
        loadEars(e, t = {}) {
            if (null === e) this.resetEars(); else {
                if (!Ua(e)) return qa(e).then((e => this.loadEars(e, t)));
                "skin" === t.textureType ? ja(this.earsCanvas, e) : Wa(this.earsCanvas, e), this.earsTexture.needsUpdate = !0, !1 !== t.makeVisible && (this.playerObject.ears.visible = !0)
            }
        }
        ...
        loadBackground(e, t) {
            if (!Ua(e)) return qa(e).then((e => this.loadBackground(e, t)));
            null !== this.backgroundTexture && this.backgroundTexture.dispose(), this.backgroundTexture = new pe, this.backgroundTexture.image = e, void 0 !== t && (this.backgroundTexture.mapping = t), this.backgroundTexture.needsUpdate = !0, this.scene.background = this.backgroundTexture
        }
        ...
        set background(e) {
            this.scene.background = null === e || e instanceof oe || e instanceof pe ? e : new oe(e), null !== this.backgroundTexture && e !== this.backgroundTexture && (this.backgroundTexture.dispose(), this.backgroundTexture = null)
        }
        ...
        const t = new ds(e.camera, e.renderer.domElement);
        return t.enablePan = !1, t.target = new xe(0, 0, 0), t.minDistance = 10, t.maxDistance = 256, t.update(), t
    }, e.invokeAnimation = as, Object.defineProperty(e, "__esModule", {value: !0})
